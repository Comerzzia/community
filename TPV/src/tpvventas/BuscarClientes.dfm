inherited FrmBuscarClientes: TFrmBuscarClientes
  ...
  object RzGroupBox3: TRzGroupBox [0]
    ...
    object RzPanel18: TRzPanel
      ...
      object EditBuscarClienteCif: TRzEdit
        Left = 128
        Top = 15
        Width = 150
        Height = 26
        ...
        ParentFont = False
        TabOrder = 0
        OnClick = EditBuscarClienteCifClick
        OnEnter = EditBuscarClienteCifEnter
      end
      object EditBuscarClienteDescripcion: TRzEdit
        Left = 128
        Top = 51
        Width = 434
        Height = 26
    ...
    object RzPanel19: TRzPanel
      ...
      Transparent = True
      VisualStyle = vsClassic
      object BtnBuscaClientes: TRzBitBtn
        AlignWithMargins = True
        Left = 0
        Top = 16
        Width = 129
  ...
  object RzGroupBox5: TRzGroupBox [1]
    ...
    object RzPanel23: TRzPanel
      ...
      TabOrder = 0
      Transparent = True
      object GridBuscarClientes: TDBGridEh
        AlignWithMargins = True
        Left = 5
        Top = 0
        Width = 873
        ...
        TitleFont.Style = []
        OnDblClick = GridBuscarClientesDblClick
        Columns = <
          item
            EditButtons = <>
            FieldName = 'DESCLI'
      ...
      object RzPanel24: TRzPanel
        ...
        TabOrder = 1
        Transparent = True
        object BtnBuscarClientesPrimero: TRzToolButton
          Left = 0
          Top = -1
          Width = 50
          Height = 45
          ...
          ParentShowHint = False
          ShowHint = False
          OnClick = BtnBuscarClientesPrimeroClick
        end
        object BtnBuscarClientesAnterior: TRzToolButton
          Left = 0
          Top = 45
          Width = 50
          Height = 45
          ...
          ParentShowHint = False
          ShowHint = False
          OnClick = BtnBuscarClientesAnteriorClick
        end
        object BtnBuscarClientesSiguiente: TRzToolButton
          Left = 0
          Top = 96
          Width = 50
          Height = 45
          ...
          ParentShowHint = False
          ShowHint = False
          OnClick = BtnBuscarClientesSiguienteClick
        end
        object BtnBuscarClientesUltimo: TRzToolButton
          Left = 0
          Top = 147
          Width = 50
          Height = 45
          ...
          ParentShowHint = False
          ShowHint = False
          OnClick = BtnBuscarClientesUltimoClick
        end
  ...
  object AdvTouchKeyboard1: TAdvTouchKeyboard [2]
    ...
    SmallFont.Style = []
    Version = '1.2.7.0'
    object BtnAceptarBuscarCliente: TRzBitBtn
      AlignWithMargins = True
      Left = 682
      Top = 156
      Width = 114
      ...
      ShowHint = False
      TabOrder = 0
      OnClick = BtnAceptarBuscarClienteClick
      DisabledIndex = 1
      ImageIndex = 0
      Images = ImagenesBuscarCliente
    end
    object BtnCancelarBuscarCliente: TRzBitBtn
      AlignWithMargins = True
      Left = 804
      Top = 156
      Width = 114
  ...
  object ImagenesBuscarCliente: TImageList
    Height = 36
    Width = 36
    Left = 665
    Top = 40
  ...
  object S_BUSCARCLIENTES: TDataSource
    OnDataChange = S_BUSCARCLIENTESDataChange
    Left = 536
    Top = 40
  end
end
