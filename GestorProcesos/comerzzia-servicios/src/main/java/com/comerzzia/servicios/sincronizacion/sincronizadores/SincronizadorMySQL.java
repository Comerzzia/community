...
import com.comerzzia.servicios.core.database.DatabaseTpvMySQL;
...
public class SincronizadorMySQL extends SincronizadorBBDD implements ISincronizador {
	...
	public void enviarConfiguracion() throws TrabajoSincronizadorException {
		try {
			...
			DatabaseTpvMySQL database = new DatabaseTpvMySQL(connTienda);
