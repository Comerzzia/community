...
public class EnviarArticulosJob implements Job {

	/**
	 * Constructor
	 */
	public EnviarArticulosJob() {
	}
	...
	public void execute(JobExecutionContext context) throws JobExecutionException {
		...
		try {
		    ...
		    if (codAlmacen == null) {
		    	throw new JobExecutionException("Error al ejecutar la tarea de envío de artículos: " 
		    			+ "No se ha recibido el parámetro con el almacén de destino");
		    }
		    
		    String resumen = ServicioSincronizador.enviarArticulos(codAlmacen, SincronizadorTiendas.getDatosSesionSincronizacion());
