...
public class TiendaNotFoundException extends Exception {
	 ...
	 * Serial Version UID
	 */
	private static final long serialVersionUID = -8100600851410374143L;
	...
	public TiendaNotFoundException(String msg, Throwable e) {
		super(msg, e);
	}

	public TiendaNotFoundException(String msg, String msgKey) {
		super(msg, msgKey);
	}
