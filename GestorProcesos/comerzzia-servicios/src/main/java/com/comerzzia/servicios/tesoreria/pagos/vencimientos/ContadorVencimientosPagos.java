...
package com.comerzzia.servicios.tesoreria.pagos.vencimientos;
...
public class ContadorVencimientosPagos {

	private static final String CONTADOR = "ID_VENCIMIENTO_PAGO";
