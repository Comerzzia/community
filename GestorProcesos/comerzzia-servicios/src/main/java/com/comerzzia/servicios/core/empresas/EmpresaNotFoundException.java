...
public class EmpresaNotFoundException extends Exception {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 110514538540584764L;
	...
	public EmpresaNotFoundException(String msg, Throwable e) {
		super(msg, e);
	}

	public EmpresaNotFoundException(String msg, String msgKey) {
		super(msg, msgKey);
	}
