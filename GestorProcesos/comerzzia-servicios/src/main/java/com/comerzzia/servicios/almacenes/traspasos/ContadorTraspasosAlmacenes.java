...
public class ContadorTraspasosAlmacenes {

	private static final String CONTADOR_ID = "ID_TRASPASO";
	private static final String CONTADOR_TRASPASO = "NUMTRASPASO";
	...
	public static Long obtenerContadorAlbaran(String codEmpresa, String codSerie, Short periodo, Connection conn) throws ContadorException {
		return ServicioContadores.obtenerContador(CONTADOR_TRASPASO, null, codSerie, null, conn);
	}
}
