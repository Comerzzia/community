...
public class RecibirTicketsJob implements Job {

	/**
	 * Constructor
	 */
	public RecibirTicketsJob() {
	}
	...
	public void execute(JobExecutionContext context) throws JobExecutionException {
		...
		try {
		    ...
		    if (codAlmacen == null) {
		    	throw new JobExecutionException("Error al ejecutar la tarea de recepción de tickets: " 
		    			+ "No se ha recibido el parámetro con el almacén de destino");
		    }
		    
			String resumen = ServicioSincronizador.recibirTickets(codAlmacen, SincronizadorTiendas.getDatosSesionSincronizacion());
