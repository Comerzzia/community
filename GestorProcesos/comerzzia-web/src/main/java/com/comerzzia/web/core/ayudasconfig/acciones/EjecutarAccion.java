...
public class EjecutarAccion extends Accion {
    ...
    public Vista ejecutar(HttpServletRequest request) {
    	try {
    		...
    		if (param == null) {
    			param = new ParametrosBuscarAyudasConfigBean();
    			
    			sesion.setAttribute(WebKeys.PARAM_BUSCAR_AYUDAS_CONFIG, param);
    		}
    		else {
    		...
    		if (formulario == null) {
    			formulario = new FormularioAyudaConfigBean();
    			
    			sesion.setAttribute(WebKeys.FORMULARIO_AYUDAS_CONFIG, formulario);
    		}
