...
public class EliminarAccion extends Accion {
	...
	public Vista ejecutar(HttpServletRequest request) {
		...
		try {
    		...
    		setMensaje(request, "El aprovisionamiento se ha eliminado correctamente");
    		
    		return getControlador().getAccion("buscar").ejecutar(request);
    	}
    	catch (PedidoVentaConstraintViolationException e) {
    		setMensajeAviso(request, "No se ha podido eliminar el aprovisionamiento: " + e.getMessage());
