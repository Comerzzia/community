    ...
    public Vista ejecutar(HttpServletRequest request) {
    	try {
    		...
    		if (param == null) {
    			...
    			sesion.setAttribute(WebKeys.PARAM_BUSCAR_ALBARANES_VENTAS, param);
    		}
    		...
    		if (formulario == null) {
    			formulario = new FormularioAlbaranVentaBean();
    			...
    			sesion.setAttribute(WebKeys.FORMULARIO_ALBARAN_VENTA, formulario);
    		}
