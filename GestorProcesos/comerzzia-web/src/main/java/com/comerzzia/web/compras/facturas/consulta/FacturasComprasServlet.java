...
package com.comerzzia.web.compras.facturas.consulta;

import com.comerzzia.web.base.ControladorServlet;
import com.comerzzia.web.compras.facturas.consulta.acciones.*;

public class FacturasComprasServlet extends ControladorServlet {

	/**
	 * 
	 */
	private static final long serialVersionUID = -7426004316344267095L;
