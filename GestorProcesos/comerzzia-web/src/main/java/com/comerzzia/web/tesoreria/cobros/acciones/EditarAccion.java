...
public class EditarAccion extends Accion {
	...
	public Vista ejecutar(HttpServletRequest request) {
		try {
    		...
    		TratamientoCobrosBean tratamientoCobrosBean = new TratamientoCobrosBean();
    		documentoCobro.setEstadoBean(Estado.MODIFICADO);
    		tratamientoCobrosBean.setDocumento(documentoCobro);
    		formulario.inicializar(tratamientoCobrosBean);
