...
package com.comerzzia.web.general.mediospago;

import com.comerzzia.web.base.ControladorServlet;
import com.comerzzia.web.general.mediospago.acciones.*;

public class MediosPagoServlet extends ControladorServlet {

	/**
	 * 
	 */
	private static final long serialVersionUID = -3661939124349587631L;
