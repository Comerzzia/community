...
public class RecepcionarPedidoAccion extends Accion {
	...
	public Vista ejecutar(HttpServletRequest request) {
    	try {
    		...
    		Long idPedido = param.getPedidosSeleccionados().get(0); // Obtener el primer y único elemento
    		Date fechaSuministro = Fechas.getFecha(request.getParameter("fechaSuministro"));
    		ServicioPedidosCompras.recepcionarPedido(datosSesion, idPedido, fechaSuministro);
    		
    		setMensaje(request, "La recepción del pedido de compra ha finalizado correctamente");
