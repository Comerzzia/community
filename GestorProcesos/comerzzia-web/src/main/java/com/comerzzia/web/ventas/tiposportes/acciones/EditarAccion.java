...
public class EditarAccion extends Accion {
    ...
    public Vista ejecutar(HttpServletRequest request) {
    	try {
    		...
    		TipoPorteBean tipoPorte = ServicioTiposPortes.consultar(idTipoPorte, datosSesion);
    		tipoPorte.setEstadoBean(Estado.MODIFICADO);
    		tipoPorte.setEnEdicion(true);
    		
    		sesion.setAttribute(WebKeys.TIPO_PORTE_BEAN, tipoPorte);
    		
    		return NEXT_PAGE;
    	}
    	catch (TipoPorteNotFoundException e) {
