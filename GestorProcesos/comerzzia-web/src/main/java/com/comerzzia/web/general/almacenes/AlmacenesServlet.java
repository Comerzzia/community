...
package com.comerzzia.web.general.almacenes;

import com.comerzzia.web.base.ControladorServlet;
import com.comerzzia.web.general.almacenes.acciones.*;

public class AlmacenesServlet extends ControladorServlet {

	/**
	 * serialVersionUID
	 */
	private static final long serialVersionUID = 4247528276013694397L;
