...
package com.comerzzia.web.core.impuestos.tratamientosimpuestos;

import com.comerzzia.web.base.ControladorServlet;
import com.comerzzia.web.core.impuestos.tratamientosimpuestos.acciones.*;

public class TratamientosImpuestosServlet extends ControladorServlet {

	/**
	 * 
	 */
	private static final long serialVersionUID = -5940294879844360531L;
