...
public class ServirPedidoAccion extends Accion {
	...
	public Vista ejecutar(HttpServletRequest request) {
    	try {
    		...
    		ServicioPedidosVentas.servirPedido(datosSesion, idPedido, fechaSuministro);
    		
    		setMensaje(request, "El pedido de venta ha sido servido correctamente");
