...
public class ConceptoAlmacenCompraAccionXML extends AccionXML {

	@Override
	public String getNombre() {
		return "conceptoAlmacenCompra";
	}
	...
	public Element ejecutar(HttpServletRequest request, Document document) throws AyudaXMLException {
		try {
			...
			ConceptoAlmacenBean conceptoAlmacen = ServicioConceptoAlmacenes.consultar(new AlbaranCompra().getCodAplicacion(), codConceptoAlmacen, datosSesion);
	        ...
	        //Si tiene códigoAlmacenDestino obtenemos la descripción de ese almacén
