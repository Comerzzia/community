...
package com.comerzzia.web.backoffice.regularizaciones;

import com.comerzzia.web.base.ControladorServlet;
import com.comerzzia.web.backoffice.regularizaciones.acciones.*;

public class RegularizacionesTiendaServlet extends ControladorServlet {

	/**
	 * Serial Version UID
	 */
	private static final long serialVersionUID = -5547623767399782508L;
