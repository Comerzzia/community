...
package com.comerzzia.web.ventas.albaranes.ui;

import com.comerzzia.servicios.ventas.albaranes.AlbaranVenta;
import com.comerzzia.web.core.ui.FormularioBean;


public class FormularioAlbaranVentaBean extends FormularioBean {
	 ...
	 * Constructor
	 */
	public FormularioAlbaranVentaBean() {
	...
	public AlbaranVenta getRegistroActivo() {
		return (AlbaranVenta) super.getRegistroActivo();
	}
