...
public class FormularioPedidoVentaBackofficeArticulosBean extends FormularioBean {
	 ...
	 * Constructor
	 */
	public FormularioPedidoVentaBackofficeArticulosBean() {
	}
	public FormularioPedidoVentaBackofficeArticulosBean(String string) {
		super();
	}
