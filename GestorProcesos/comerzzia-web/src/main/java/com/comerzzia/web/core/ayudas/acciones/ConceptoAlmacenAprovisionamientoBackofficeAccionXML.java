...
public class ConceptoAlmacenAprovisionamientoBackofficeAccionXML extends AccionXML {

	public String getNombre() {
		return "conceptoAlmacenAprovisionamientoBackoffice";
	}
	...
	public Element ejecutar(HttpServletRequest request, Document document)
		...
		try {
			...
			ConceptoAlmacenBean conceptoAlmacen = ServicioConceptoAlmacenes.consultarParaTienda(new AlbaranVenta().getCodAplicacion(), codConceptoAlmacen,true, datosSesion);
