...
package com.comerzzia.web.core.impuestos.porcentajes;

import com.comerzzia.web.base.ControladorServlet;
import com.comerzzia.web.core.impuestos.porcentajes.acciones.*;

public class PorcentajesImpuestosServlet extends ControladorServlet {

	/**
	 * Serial Version UID
	 */
	private static final long serialVersionUID = 2224162806222159374L;
