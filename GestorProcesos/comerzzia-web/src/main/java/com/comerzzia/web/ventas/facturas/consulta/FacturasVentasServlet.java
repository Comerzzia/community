...
package com.comerzzia.web.ventas.facturas.consulta;

import com.comerzzia.web.base.ControladorServlet;
import com.comerzzia.web.ventas.facturas.consulta.acciones.*;


public class FacturasVentasServlet extends ControladorServlet {

	/**
	 * Serial Version UID
	 */
	private static final long serialVersionUID = -7331907058791513041L;
