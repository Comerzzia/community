...
import com.comerzzia.servicios.core.empresas.EmpresaNotFoundException;
...
public class EditarAccion extends Accion {
    ...
    public Vista ejecutar(HttpServletRequest request) {
    	try {
    		...
    		EmpresaBean empresa = ServicioEmpresas.consultar(datosSesion);
    		empresa.setEstadoBean(Estado.MODIFICADO);
    		empresa.setEnEdicion(true);
    		...
    		// Si no se encuentra el registro volvemos a ver la empresa y enviamos en mensaje de error
