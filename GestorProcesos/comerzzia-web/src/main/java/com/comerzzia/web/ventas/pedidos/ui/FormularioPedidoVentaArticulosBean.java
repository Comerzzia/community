...
public class FormularioPedidoVentaArticulosBean extends FormularioBean {
	 ...
	 * Constructor
	 */
	public FormularioPedidoVentaArticulosBean() {
	}
	
	public FormularioPedidoVentaArticulosBean(String string) {
		super();
	}
