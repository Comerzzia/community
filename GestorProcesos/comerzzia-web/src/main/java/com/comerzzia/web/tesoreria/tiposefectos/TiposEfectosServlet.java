...
package com.comerzzia.web.tesoreria.tiposefectos;

import com.comerzzia.web.base.ControladorServlet;
import com.comerzzia.web.tesoreria.tiposefectos.acciones.*;

public class TiposEfectosServlet extends ControladorServlet {

	/**
	 * 
	 */
	private static final long serialVersionUID = 7463009613683599855L;
