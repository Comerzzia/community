...
public class VerAccion extends Accion {
    ...
    public Vista ejecutar(HttpServletRequest request) {
    	try {
    		...
    		Long idFacturaSop = Long.parseLong(request.getParameter(WebKeys.ID_OBJETO));
    		FacturaCompra factura = ServicioFacturasCompras.consultar(idFacturaSop, datosSesion);
    	...
    	catch (FacturaCompraNotFoundException e) {
