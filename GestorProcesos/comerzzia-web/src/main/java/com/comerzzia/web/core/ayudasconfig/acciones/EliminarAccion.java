...
public class EliminarAccion extends Accion {
    ...
    public Vista ejecutar(HttpServletRequest request) {
		...
		try {
    		...
    		ServicioAyudasConfig.eliminar(nombre);

    		setMensaje(request, "La ayuda se ha borrado correctamente");
    		
    		return getControlador().getAccion("buscar").ejecutar(request);
    	}
    	catch (AyudaConfigConstraintViolationException e) {
    		setMensajeError(request, "No se ha podido borrar la ayuda porque existen registros asociados");
