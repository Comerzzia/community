...
package com.comerzzia.web.core.impuestos.tiposimpuestos;

import com.comerzzia.web.base.ControladorServlet;
import com.comerzzia.web.core.impuestos.tiposimpuestos.acciones.*;


public class TiposImpuestosServlet extends ControladorServlet {

	/**
	 * 
	 */
	private static final long serialVersionUID = -4997691522647651572L;
