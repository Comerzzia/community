...
public class VerFormularioAccion extends Accion {
	...
	private static final Vista NEXT_PAGE = new Vista("core/impuestos/porcentajes/mantenimiento/jsp/porcentaje.jsp", Vista.INTERNA);
	...
	private void inicializaPestañaActiva(FormularioPorcentajeImpuestosBean formulario, DatosSesionBean datosSesion, HttpServletRequest request) throws Exception {
