...
public class AceptarMultiplesPedidosAccion extends Accion {
	...
	public Vista ejecutar(HttpServletRequest request) {
    	try {
    		...
    		ServicioPedidosVentas.aceptarMultiplesPedidos(datosSesion, idsPedido);
    		
    		setMensaje(request, "Los pedidos de venta seleccionados han sido aceptados correctamente");
