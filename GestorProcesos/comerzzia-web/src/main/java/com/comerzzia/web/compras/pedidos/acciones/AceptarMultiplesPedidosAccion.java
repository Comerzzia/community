...
public class AceptarMultiplesPedidosAccion extends Accion {
    ...
    public String getNombre() {
        return "aceptarMultiplesPedidos";
    }
	...
	public Vista ejecutar(HttpServletRequest request) {
    	try {
    		...
    		ServicioPedidosCompras.aceptarMultiplesPedidos(datosSesion, idsPedido);
    		
    		setMensaje(request, "Los pedidos de compra seleccionados han sido aceptados correctamente");
