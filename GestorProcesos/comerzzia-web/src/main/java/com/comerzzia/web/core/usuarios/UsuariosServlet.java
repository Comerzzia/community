...
package com.comerzzia.web.core.usuarios;

import com.comerzzia.web.base.ControladorServlet;
import com.comerzzia.web.core.usuarios.acciones.*;


public class UsuariosServlet extends ControladorServlet {

	/**
	 * Serial Version UID
	 */
	private static final long serialVersionUID = 1341742045679015772L;
	...
	protected void loadAcciones() {
		...
		this.añadirAccion(new RestablecerContraseñaAccion());
