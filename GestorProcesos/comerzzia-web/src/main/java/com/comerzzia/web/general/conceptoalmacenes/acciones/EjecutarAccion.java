...
public class EjecutarAccion extends Accion {
	...
	public EjecutarAccion (String codAplicacion){
    ...
    public Vista ejecutar(HttpServletRequest request) {
    	try {
    		...
    		if (param == null) {
    			param = new ParametrosBuscarConceptoAlmacenBean();
    			
    			sesion.setAttribute(WebKeys.PARAM_BUSCAR_CONCEPTO_ALMACENES, param);
    		}
