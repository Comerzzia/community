...
package com.comerzzia.web.backoffice.ventas.pedidos.ui;

import com.comerzzia.servicios.ventas.pedidos.PedidoVenta;
import com.comerzzia.web.core.ui.FormularioBean;


public class FormularioPedidoVentaBackofficeBean extends FormularioBean {

	// Definición de las pestañas del formulario
	private FormularioBean pestañaCabecera = new FormularioBean("Pedido");
	private FormularioPedidoVentaBackofficeArticulosBean pestañaDetalle = new FormularioPedidoVentaBackofficeArticulosBean("Artículos");
	 ...
	 * Constructor
	 */
	public FormularioPedidoVentaBackofficeBean() {
	...
	public FormularioPedidoVentaBackofficeArticulosBean getFormularioPestañaArticulos(){
