...
import com.comerzzia.servicios.ventas.facturas.FacturaVentaNotFoundException;
...
public class VerAccion extends Accion {
    ...
    public Vista ejecutar(HttpServletRequest request) {
    	try {
    		...
    		Long idFacturaRep = Long.parseLong(request.getParameter(WebKeys.ID_OBJETO));
    		FacturaVenta factura = ServicioFacturasVentas.consultar(idFacturaRep, datosSesion);
    		...
    		formulario.inicializar(factura);
