...
package com.comerzzia.web.ventas.facturas.consulta.ui;

import com.comerzzia.servicios.ventas.facturas.FacturaVenta;
import com.comerzzia.web.core.ui.FormularioBean;


public class FormularioFacturaVentaBean extends FormularioBean {
	 ...
	 * Constructor
	 */
	public FormularioFacturaVentaBean() {
	...
	protected void inicializaRegistroActivo() {
		...
		pestañaLineas.setRegistros(((FacturaVenta)this.getRegistroActivo()).getDetallesFactura());
		pestañaMediosPago.setRegistros(((FacturaVenta)this.getRegistroActivo()).getMediosPago());
	}
