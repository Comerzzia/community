...
public class FormularioPedidoCompraBean extends FormularioBean {

	// Definición de las pestañas del formulario
	private FormularioBean pestañaCabecera = new FormularioBean("Pedido");
	private FormularioPedidoCompraArticulosBean pestañaDetalle = new FormularioPedidoCompraArticulosBean("Artículos");
	 ...
	 * Constructor
	 */
	public FormularioPedidoCompraBean() {
	...
	public PedidoCompra getRegistroActivo() {
		return (PedidoCompra) super.getRegistroActivo();
	}
	...
	public FormularioPedidoCompraArticulosBean getFormularioPestañaArticulos(){
