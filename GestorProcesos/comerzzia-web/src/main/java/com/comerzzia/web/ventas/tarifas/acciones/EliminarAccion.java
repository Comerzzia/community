...
public class EliminarAccion extends Accion {
	...
	public Vista ejecutar(HttpServletRequest request) {
		...
		try {
			...
			ServicioTarifas.eliminar(codTar, datosSesion);

			setMensaje(request, "La tarifa se ha borrado correctamente");

    		return getControlador().getAccion("buscar").ejecutar(request);
		} 
		catch (TarifaConstraintViolationException e) {
			setMensajeError(request,"No se ha podido borrar la tarifa porque existen registros asociados");
