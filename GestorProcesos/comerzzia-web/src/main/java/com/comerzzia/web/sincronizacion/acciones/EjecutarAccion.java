...
public class EjecutarAccion extends Accion {
    ...
    public Vista ejecutar(HttpServletRequest request) {
    	try {
    		...
    		if (formulario == null) {
    			formulario = new FormularioSincronizacionBean();
    			
    			sesion.setAttribute(WebKeys.FORMULARIO_SINCRONIZACION, formulario);
    		}
    		
    		// Inicializamos siempre ya que no tenemos accion buscar, por lo tanto lo hacemos aquí
    		formulario.inicializar();
    		formulario.setPestañaActiva(0);
    		
    		// Inicializamos en las pestañas en modo tabla
