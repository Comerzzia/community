...
public class PrepararPedidoAccion extends Accion {
	...
	public Vista ejecutar(HttpServletRequest request) {
    	try {
    		...
    		ServicioPedidosVentas.prepararPedido(datosSesion, idPedido);
    		
    		setMensaje(request, "El pedido de venta ha sido preparado correctamente");
