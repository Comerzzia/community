...
package com.comerzzia.web.general.proveedores;

import com.comerzzia.web.base.ControladorServlet;
import com.comerzzia.web.general.proveedores.acciones.*;

public class ProveedoresServlet extends ControladorServlet {

	/**
	 * serialVersionUID.
	 */
	private static final long serialVersionUID = -3526583498558073091L;
