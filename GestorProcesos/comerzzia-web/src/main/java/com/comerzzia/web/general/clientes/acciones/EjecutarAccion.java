...
public class EjecutarAccion extends Accion {
	...
	public Vista ejecutar(HttpServletRequest request) {
		try {
			...
			if (param == null) {
				param = new ParametrosBuscarClientesBean();

				sesion.setAttribute(WebKeys.PARAM_BUSCAR_CLIENTES, param);
			} else {
			...
			if (formulario == null) {
				formulario = new FormularioClienteBean();

				sesion.setAttribute(WebKeys.FORMULARIO_CLIENTE, formulario);
			}
