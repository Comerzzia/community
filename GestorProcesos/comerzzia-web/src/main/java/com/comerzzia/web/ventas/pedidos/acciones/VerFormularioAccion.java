...
public class VerFormularioAccion extends Accion {
	...
	private static final Vista NEXT_PAGE = new Vista("ventas/pedidos/mantenimiento/jsp/pedido.jsp", Vista.INTERNA);
	...
	private void inicializaPestañaActiva(FormularioPedidoVentaBean formulario, DatosSesionBean datosSesion,HttpServletRequest request) throws Exception {
