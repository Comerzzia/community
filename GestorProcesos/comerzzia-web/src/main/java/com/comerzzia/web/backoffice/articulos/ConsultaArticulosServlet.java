...
package com.comerzzia.web.backoffice.articulos;

import com.comerzzia.web.backoffice.articulos.acciones.*;
import com.comerzzia.web.base.ControladorServlet;

public class ConsultaArticulosServlet extends ControladorServlet {

	/**
	 * 
	 */
	private static final long serialVersionUID = 6061146369384860753L;
