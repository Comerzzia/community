...
import com.comerzzia.web.tesoreria.remesas.cobros.acciones.*;

public class RemesasCobrosServlet extends ControladorServlet {
	...
	protected void loadAcciones() {
		...
		añadirAccion(new GenerarDevolucionDocumentoAccion());
	}
