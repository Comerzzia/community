...
public class AsistenteInsercionAccion extends Accion {

	private static final Vista NEXT_PAGE_PASO1 = new Vista("ventas/tarifas/insercionMasiva/jsp/asistInsercPaso1.jsp", Vista.INTERNA);
	private static final Vista NEXT_PAGE_PASO2 = new Vista("ventas/tarifas/insercionMasiva/jsp/asistInsercPaso2.jsp", Vista.INTERNA);
	private static final Vista NEXT_PAGE_PASO3 = new Vista("ventas/tarifas/insercionMasiva/jsp/asistInsercPaso3.jsp", Vista.INTERNA);
	private static final Vista NEXT_PAGE_PASO4 = new Vista("ventas/tarifas/insercionMasiva/jsp/asistInsercPaso4.jsp", Vista.INTERNA);
	private static final Vista NEXT_PAGE_PASO5 = new Vista("ventas/tarifas/insercionMasiva/jsp/asistInsercPaso5.jsp", Vista.INTERNA);
		...
		try{
			switch (param.getPaso()) {
				...
				case PASO3:
					...
					return NEXT_PAGE_PASO4;
				case PASO4:
					ServicioTarifas.insercionArticulosMasiva(param,datosSesion);
					param.setPaso(PASO5);
