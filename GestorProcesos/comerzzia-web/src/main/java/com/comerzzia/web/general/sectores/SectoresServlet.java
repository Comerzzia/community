...
package com.comerzzia.web.general.sectores;

import com.comerzzia.web.base.ControladorServlet;
import com.comerzzia.web.general.sectores.acciones.*;

public class SectoresServlet extends ControladorServlet {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 376402533122326032L;
