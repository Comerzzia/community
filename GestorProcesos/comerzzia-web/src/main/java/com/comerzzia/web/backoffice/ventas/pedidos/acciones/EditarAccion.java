...
public class EditarAccion extends Accion {
    ...
    public Vista ejecutar(HttpServletRequest request) {
    	try {
    		...
    		//TODO: Se estable el cliente del pedido, estudiar cuál sería el lugar adecuado para hacerlo
    		...
    		try {
    			...
    			setMensajeAviso(request, "No se puede editar el aprovisionamiento: " + e.getMessage());
			}
