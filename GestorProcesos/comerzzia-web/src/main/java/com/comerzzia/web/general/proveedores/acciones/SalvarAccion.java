...
public class SalvarAccion extends Accion {
	...
	public Vista ejecutar(HttpServletRequest request) {
		try {
			...
			// Obtenemos el proveedor del formulario y lo salvamos
			...
			ProveedorBean proveedor = (ProveedorBean) formulario
					.getRegistroActivo();
			ServicioProveedores.salvar(proveedor, datosSesion);
			formulario.aceptar();

			setMensaje(request, "El proveedor se ha grabado correctamente");
