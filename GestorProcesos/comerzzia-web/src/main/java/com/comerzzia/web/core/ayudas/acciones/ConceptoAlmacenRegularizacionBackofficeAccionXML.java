...
public class ConceptoAlmacenRegularizacionBackofficeAccionXML extends AccionXML {

	@Override
	public String getNombre() {
		return "conceptoAlmacenRegularizacionBackoffice";
	}
	...
	public Element ejecutar(HttpServletRequest request, Document document)
		...
		try {
			...
			ConceptoAlmacenBean conceptoAlmacen = regularizacion
					.getConceptoAlmacenParaTienda(datosSesion);
