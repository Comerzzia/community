...
public class FormularioServirPedidosAccion extends Accion {

	private static final Vista NEXT_PAGE = new Vista("ventas/pedidos/buscar/jsp/servir.jsp", Vista.INTERNA);
	...
	public Vista ejecutar(HttpServletRequest request) {
    	try {
    		...
    		List<PedidoVenta> resumenPedidosSeleccionados = new ArrayList<PedidoVenta>();
    		...
    		if(pedidosSeleccionados.isEmpty()) {
    			...
    			resumenPedidosSeleccionados.add(ServicioPedidosVentas.consultar(idPedido, datosSesion));
    		}
