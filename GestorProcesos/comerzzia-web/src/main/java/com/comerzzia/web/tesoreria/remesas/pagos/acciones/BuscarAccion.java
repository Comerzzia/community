...
public class BuscarAccion extends Accion {
	...
	private static final Vista NEXT_PAGE = new Vista("tesoreria/remesas/pagos/buscar/jsp/buscar.jsp", Vista.INTERNA);
	...
	public Vista ejecutar(HttpServletRequest request) {
		try {
            ...
            if (param.getNumPagina() > 0) {
                PaginaResultados paginaResultados = ServicioRemesasPagos.consultar(param, datosSesion);
	...
	private void setParametrosBuscar(ParametrosBuscarRemesasPagosBean param, HttpServletRequest request) {
	...
	private void setPaginaBuscar(ParametrosBuscarRemesasPagosBean param, HttpServletRequest request) {
        try {
	...
	private void setOrdenBuscar(ParametrosBuscarRemesasPagosBean param, HttpServletRequest request) {
    	try {
