    ...
    public Vista ejecutar(HttpServletRequest request) {
    	try {
    		...
    		if (param == null) {
    			...
    			sesion.setAttribute(WebKeys.PARAM_BUSCAR_ALBARANES_FACTURAS, param);
    		...
    		if (formulario == null) {
    			formulario = new FormularioConformacionFacturasBean();  			
    			sesion.setAttribute(WebKeys.FORMULARIO_CONFORMACION_FACTURAS, formulario);
