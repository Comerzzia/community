...
public class EjecutarAccion extends Accion {
	...
	public Vista ejecutar(HttpServletRequest request) {
		try {
			...
			if (param == null) {
				param = new ParametrosBuscarProveedoresBean();

				sesion.setAttribute(WebKeys.PARAM_BUSCAR_PROVEEDORES, param);
			} else {
			...
			if (formulario == null) {
				formulario = new FormularioProveedorBean();

				sesion.setAttribute(WebKeys.FORMULARIO_PROVEEDOR, formulario);
			}
