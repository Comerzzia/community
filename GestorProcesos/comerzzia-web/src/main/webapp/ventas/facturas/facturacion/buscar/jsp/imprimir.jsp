  ...
  <body onload="inicio();">
    <cmz:main>
      <cmz:panelCMZ>
        ...
        <cmz:cuerpoPanelCMZ>
          <cmz:mensaje/>
          <form id="frmDatos" name="frmDatos" action="facturacionAlbaranesVentas" method="POST" target="_self">
              ...
              <cmz:cuerpoPanel>
	            <table cellpadding="2px" cellspacing="2px" border="0px">
	              <tr>
	                <td>Periodo:</td>
	                <td>
	                	<cmz:campoTexto id="periodo" valor="${factura.periodo}" requerido="true" 
	              ...
	              <tr>
			        ...
			        <td>
			        	<cmz:ayuda nombreAyuda="SERIES" requerido="true">
			                ...
			                <cmz:descripcionAyuda idDescripcion="desSerie" valorDescripcion="${factura.desSerie}" anchuraDescripcion="300px" editable="true" />
			            </cmz:ayuda>
			        </td>
				  </tr>	              
				  <tr>
	                ...
	                <td>
	                	<cmz:campoTexto id="numFacturaDesde" valor="${formularioFacturacionAlbaranesVentas.primeraFactura}"
				  ...
				  <tr>
	                ...
	                <td>
	                	<cmz:campoTexto id="numFacturaHasta" valor="${formularioFacturacionAlbaranesVentas.ultimaFactura}"
	                		anchura="100px" longitudMaxima="10"/>
	                </td>
				  </tr>	                
	            </table>  
