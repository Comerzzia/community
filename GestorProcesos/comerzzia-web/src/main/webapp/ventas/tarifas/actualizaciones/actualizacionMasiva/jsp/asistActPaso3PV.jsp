...
<cmz:panel>
	<cmz:cabeceraPanel titulo="Actualización de Precios de Venta para la Actualización ${actualizacionAsistente.idActualizacion}"></cmz:cabeceraPanel>
	<cmz:cuerpoPanel>
					...
					<tr>
						<td>
							<input type="radio" value="actualizarPreciosVentaPV" id="criterioOpcion" name="criterioOpcion" tabindex="1"
								<c:if test="${actualizacionAsistente.operacionActualizarPrecioVentaPV}">checked="checked"</c:if>
						...
						<td>
							<cmz:campoTexto id="porcentajeIncDec" anchura="100px" longitudMaxima="6"  onChange="borrarCampos(this);" soloLectura="true" >
                                <cmz:formateaNumero valor="${actualizacionAsistente.porcentajeIncDec}" numDecimales="2"></cmz:formateaNumero>
							</cmz:campoTexto>
						</td>
					</tr>
					<tr>
						<td>
							<input type="radio" value="actualizarPreciosVentaPT" id="criterioOpcion" name="criterioOpcion" tabindex="2"
								<c:if test="${actualizacionAsistente.operacionActualizarPrecioVentaPT}">checked="checked"</c:if>
								onclick="actualizarCriterio(this);" >
						...
						<td>
							<cmz:campoTexto id="importeIncDec" anchura="100px" longitudMaxima="14" onChange="borrarCampos(this);" soloLectura="true" >   
                              <cmz:formateaNumero valor="${actualizacionAsistente.importeIncDec}" numDecimales="2"></cmz:formateaNumero>
							</cmz:campoTexto>
						</td>
					</tr>
					<tr>
						<td>
							<input type="radio" value="actualizarPreciosVentaPC" id="criterioOpcion" name="criterioOpcion" tabindex="3"
								<c:if test="${actualizacionAsistente.operacionActualizarPrecioVentaPC}">checked="checked"</c:if>
								onclick="actualizarCriterio(this);" >
						...
						<td>
							<cmz:campoTexto id="factorMargen" anchura="100px" longitudMaxima="6" onChange="borrarCampos(this);" soloLectura="true"  >
                              <cmz:formateaNumero valor="${actualizacionAsistente.factorMargen}" numDecimales="2"></cmz:formateaNumero>
							</cmz:campoTexto>
						</td>
					</tr>
					<tr>
						<td>
							<input type="checkbox" value="true" id="redondear" name="redondear" 
								<c:if test="${actualizacionAsistente.redondear}">checked="checked"</c:if>/>
