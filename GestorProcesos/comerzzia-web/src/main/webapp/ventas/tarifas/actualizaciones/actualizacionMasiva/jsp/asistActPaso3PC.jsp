...
<cmz:panel>
	<cmz:cabeceraPanel titulo="Actualización de Precios de Costo para la Actualización ${tarifaAsistente.idActualizacion}"></cmz:cabeceraPanel>
	<cmz:cuerpoPanel>
					...
					<tr>
						...
						<td>
							<cmz:campoTexto id="porcentajeIncDec" anchura="100px" longitudMaxima="6"  onChange="borrarCampos(this);" >
                                <cmz:formateaNumero valor="${actualizacionAsistente.porcentajeIncDec}" numDecimales="2"/>
							</cmz:campoTexto>
						</td>
					</tr>
