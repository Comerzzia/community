...
<body onkeydown="keyDown(event);">
	...
	<cmz:panelCMZ>
		...
		<cmz:cuerpoPanelCMZ>
			...
			<cmz:panel>
				<cmz:cabeceraPanel titulo="Resumen de la Operación"></cmz:cabeceraPanel>
				<cmz:cuerpoPanel>
					<table cellpadding="2px" cellspacing="2px" border="0px" class="insercionMasiva">
						<tr>
							<td>
								<cmz:campoAreaTexto id="resumen" valor="${actualizacionAsistente.resumenInsercionMasiva}" 
									requerido="false" altura="120" anchura="700" editable="false" soloLectura="true" />
							</td>
						</tr>
