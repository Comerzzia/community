...
<c:set var="articulo" value="${formularioActualizacionTarifa.formularioPestañaActiva.registroActivo}" />
...
<cmz:panel>
  <cmz:cabeceraPanel titulo="Artículo">
    <cmz:acciones numAccionesVisibles="8">
      <c:choose>
        <c:when test="${formularioActualizacionTarifa.formularioPestañaActiva.editable}">
        ...
        <c:otherwise>
          ...
          <c:if test="${formularioActualizacionTarifa.editable}">
            ...
            <cmz:accion icono="comun/images/iconos/editar.gif" descripcion="Editar Artículo" onclick="editarRegistroPestaña(${formularioActualizacionTarifa.formularioPestañaActiva.indiceRegistroActivo});" />
            <cmz:accion icono="comun/images/iconos/eliminar.gif" descripcion="Eliminar Artículo" onclick="eliminarRegistroPestaña(${formularioActualizacionTarifa.formularioPestañaActiva.indiceRegistroActivo});" />
          </c:if>
          
          <cmz:accionNavegacionRegistros onclick="verRegistroPestaña" 
               total="${formularioActualizacionTarifa.formularioPestañaActiva.total}" 
               actual="${formularioActualizacionTarifa.formularioPestañaActiva.actual}" 
               primero="${formularioActualizacionTarifa.formularioPestañaActiva.primero}"
               anterior="${formularioActualizacionTarifa.formularioPestañaActiva.anterior}"
               siguiente="${formularioActualizacionTarifa.formularioPestañaActiva.siguiente}"
               ultimo="${formularioActualizacionTarifa.formularioPestañaActiva.ultimo}"/>
        </c:otherwise>
      </c:choose>
    </cmz:acciones>
  </cmz:cabeceraPanel>
  ...
  <cmz:cuerpoPanel>
    <table cellpadding="2px" cellspacing="2px" border="0px">
      <tr>
        <td>Artículo:</td>
        <td>
          <cmz:ayuda soloLectura="${!formularioActualizacionTarifa.formularioPestañaActiva.enInsercion}" nombreAyuda="ARTICULOS" requerido="true" onclick="ayudaArticuloTarifa();">
      ...
      <tr>
        <td>Precio costo:</td>
        <td>
          <cmz:campoTexto id="precioCosto" valor="${articulo.precioCosto}" editable="${formularioActualizacionTarifa.formularioPestañaActiva.editable}" 
              soloLectura="${!formularioActualizacionTarifa.formularioPestañaActiva.editable}" anchura="70" longitudMaxima="14" requerido="true"
      ...
      <tr>
        ...
        <td>
          <cmz:campoTexto  id="factorMarcaje" valor="${articulo.factorMarcaje}" editable="${formularioActualizacionTarifa.formularioPestañaActiva.editable}" 
              soloLectura="${!formularioActualizacionTarifa.formularioPestañaActiva.editable}" anchura="70" longitudMaxima="14" requerido="false"
      ...
      <tr>
        ...
        <td>
          <cmz:campoTexto id="precioMarcaje" editable="${formularioActualizacionTarifa.formularioPestañaActiva.editable}" 
              soloLectura="${!formularioActualizacionTarifa.formularioPestañaActiva.editable}" anchura="70" longitudMaxima="14" requerido="false"
      ...
      <tr>
        ...
        <td>
          <cmz:campoTexto id="precioMarcajeImpuestos" editable="${formularioActualizacionTarifa.formularioPestañaActiva.editable}" 
              soloLectura="${!formularioActualizacionTarifa.formularioPestañaActiva.editable}" anchura="70" longitudMaxima="14" requerido="false"
