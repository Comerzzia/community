	...
	<cmz:panelCMZ>
		...
		<cmz:cuerpoPanelCMZ>
            ...
            <input id="idObjeto" name="idObjeto" type="hidden" value="${actualizacionAsistente.idActualizacion}" />
				...
				<cmz:panel>
				<cmz:cabeceraPanel titulo="Criterio de Actualización de Artículos para la Actualización ${actualizacionAsistente.idActualizacion}"></cmz:cabeceraPanel>
				<cmz:cuerpoPanel>
					<table cellpadding="2px" cellspacing="2px" border="0px" class="actualizacionMasiva">
						...
						<tr>
							<td>
								...
								<c:if test="${actualizacionAsistente.criterio == null || actualizacionAsistente.operacionActualizarPrecioVenta}">checked="checked"</c:if>>
						...
						<tr>
							<td>
								...
								<c:if test="${actualizacionAsistente.operacionActualizarPrecioCosto}">checked="checked"</c:if>> 
						...
						<tr>
							<td>
								...
								<c:if test="${actualizacionAsistente.operacionActualizarEliminando}">checked="checked"</c:if>> 
