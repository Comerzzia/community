...
<cmz:main>
	<cmz:panelCMZ>
		...
		<cmz:cuerpoPanelCMZ>
			...
			<cmz:panel>
				<cmz:cabeceraPanel titulo="Resultado de la Operación de Actualización para la Tarifa ${tarifaAsistente.codTarActual}"></cmz:cabeceraPanel>
				<cmz:cuerpoPanel>
							...
							<table cellpadding="2px" cellspacing="2px" border="0px" class="actualizacionMasiva">
								<tr>
									<td><cmz:campoAreaTexto id="resultado"
										valor="${tarifaAsistente.resultadoActualizacionMasiva}" requerido="false"
