...
<html>
  <head>
    ...
    <script type="text/javascript">
	    function inicio() {
	        document.getElementById("codTarifaDesde").focus();
	    }
	    function volver() {
  ...
  <body onload="inicio();" >
    <cmz:main>
      <cmz:panelCMZ>
        ...
        <cmz:cuerpoPanelCMZ>
          <cmz:mensaje/>
          <form id="frmDatos" name="frmDatos" action="tarifas" method="POST" target="_self">
	              ...
	              <tr>
	                ...
	                <td>
	                	<cmz:ayuda nombreAyuda="TARIFAS">
	                		<cmz:codigoAyuda idCodigo="codTarifaDesde" longitudMaximaCodigo="5" anchuraCodigo="70px"  />
	                		<cmz:descripcionAyuda idDescripcion="desTarifaDesde" anchuraDescripcion="200px"  />
	                	</cmz:ayuda>
	                </td>
				  </tr>	                
	              <tr>
	                ...
	                <td>
	                	<cmz:ayuda nombreAyuda="TARIFAS">
	                		<cmz:codigoAyuda idCodigo="codTarifaHasta" longitudMaximaCodigo="5" anchuraCodigo="70px" />
	                		<cmz:descripcionAyuda idDescripcion="desTarifaHasta" anchuraDescripcion="200px" />
	                	</cmz:ayuda>
	                </td>
				  </tr>
	            </table>  
