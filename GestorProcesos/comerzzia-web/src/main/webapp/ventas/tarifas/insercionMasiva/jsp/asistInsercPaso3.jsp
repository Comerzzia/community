					...
					<table cellpadding="2px" cellspacing="2px" border="0px" class="insercionMasiva">
						<tr>
							<td>
								...
								<c:if test="${tarifaAsistente.operacionInsertarActualizar || tarifaAsistente.criterio == null}">checked="checked"</c:if>>
						...
						<tr>
							<td>
								<input id="criterioAct2" type="radio" name="criterio" value="insertarSolo"
									<c:if test="${tarifaAsistente.operacionInsertarSolo}">checked="checked"</c:if>>
