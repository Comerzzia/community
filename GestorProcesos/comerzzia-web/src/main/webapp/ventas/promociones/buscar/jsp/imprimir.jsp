...
<html>
  <head>
    ...
    <script type="text/javascript">
	    function inicio() {
	        document.getElementById("idPromocionDesde").focus();
	    }
	    function volver() {
  ...
  <body onload="inicio();" >
    <cmz:main>
      <cmz:panelCMZ>
        ...
        <cmz:cuerpoPanelCMZ>
          <cmz:mensaje/>
          <form id="frmDatos" name="frmDatos" action="promociones" method="POST" target="_self">
            ...
            <cmz:panel>
              ...
              <cmz:cuerpoPanel>
	            <table cellpadding="2px" cellspacing="2px" border="0px">
	              <tr>
	                <td>Promocion desde:</td>
	                <td>
	                	<cmz:ayuda nombreAyuda="PROMOCIONES">
	                		<cmz:codigoAyuda idCodigo="idPromocionDesde" longitudMaximaCodigo="10" anchuraCodigo="70px"  />
	                		<cmz:descripcionAyuda idDescripcion="desPromocionDesde" anchuraDescripcion="200px"  />
	                	</cmz:ayuda>
	                </td>
				  </tr>	                
	              <tr>
	                <td>Promocion hasta:</td>
	                <td>
	                	<cmz:ayuda nombreAyuda="PROMOCIONES">
	                		<cmz:codigoAyuda idCodigo="idPromocionHasta" longitudMaximaCodigo="10" anchuraCodigo="70px" />
	                		<cmz:descripcionAyuda idDescripcion="desPromocionHasta" anchuraDescripcion="200px" />
	                	</cmz:ayuda>
	                </td>
				  </tr>
	            </table>  
