...
<c:set var="desgloses" value="${formularioPedidoVenta.formularioPestañaArticulos.desgloses}" />
...
<cmz:panel>
  <cmz:cabeceraPanel titulo="Introducción Masiva de Artículos">
    <cmz:acciones>
       <cmz:accion onclick="aceptarRegistroMasivoPestaña();" titulo="Aceptar" icono="comun/images/iconos/aceptar.gif"></cmz:accion>
