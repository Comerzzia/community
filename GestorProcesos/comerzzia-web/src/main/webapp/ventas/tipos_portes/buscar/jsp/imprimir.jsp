...
<html>
  <head>
    ...
    <script type="text/javascript">
	    function inicio() {
	        document.getElementById("idTipoPorteDesde").focus();
	    }
	    function volver() {
  ...
  <body onload="inicio();" >
    <cmz:main>
      <cmz:panelCMZ>
        ...
        <cmz:cuerpoPanelCMZ>
          <cmz:mensaje/>
          <form id="frmDatos" name="frmDatos" action="tiposPortes" method="POST" target="_self">
            ...
            <cmz:panel>
              ...
              <cmz:cuerpoPanel>
	            <table cellpadding="2px" cellspacing="2px" border="0px">
	              <tr>
	                <td>Tipos de Portes desde:</td>
	                <td>
	                	<cmz:ayuda nombreAyuda="TIPOSPORTES">
	                		<cmz:codigoAyuda idCodigo="idTipoPorteDesde" longitudMaximaCodigo="5" anchuraCodigo="70px"  />
	                		<cmz:descripcionAyuda idDescripcion="desTipoPorteDesde" anchuraDescripcion="200px"  />
	                	</cmz:ayuda>
	                </td>
				  </tr>	                
	              <tr>
	                <td>Tipos de Portes hasta:</td>
	                <td>
	                	<cmz:ayuda nombreAyuda="TIPOSPORTES">
	                		<cmz:codigoAyuda idCodigo="idTipoPorteHasta" longitudMaximaCodigo="5" anchuraCodigo="70px" />
	                		<cmz:descripcionAyuda idDescripcion="desTipoPorteHasta" anchuraDescripcion="200px" />
	                	</cmz:ayuda>
	                </td>
				  </tr>
	              <tr>
