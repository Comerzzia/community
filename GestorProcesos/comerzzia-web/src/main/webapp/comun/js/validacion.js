...
function validarFechaMenorIgual(fecha1, fecha2){
    var resultado = false;
	...
	//en estas líneas creamos las fechas 
	miFecha1 = new Date(ano1,mes1 - 1,dia1); 
	miFecha2 = new Date(ano2,mes2 - 1,dia2); 
	
	dia1 = miFecha1.getDate();
	mes1 = parseInt(miFecha1.getMonth()) + 1; 
	ano1 = miFecha1.getFullYear(); 
	
	dia2 = miFecha2.getDate();
	mes2 = parseInt(miFecha2.getMonth()) + 1;
	ano2 = miFecha2.getFullYear(); 
...
function validarCifNif(texto){
    var regular = new RegExp(/^[ABCDEFGHKLMNPQS]/); 
    
    if (regular.exec(texto)){
        //COMIENZA POR UNA LETRA, POR LO QUE HACEMOS LA VALIDACION DE CIF
  	  if(validacionCif(texto)){
        ...
        //HACEMOS VALIDACION DE NIF
  	  if(validacionNif(texto)){
