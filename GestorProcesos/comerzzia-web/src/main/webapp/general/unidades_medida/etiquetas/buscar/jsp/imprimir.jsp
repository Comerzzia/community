  ...
  <body>
    <cmz:main>
      <cmz:panelCMZ>
        ...
        <cmz:cuerpoPanelCMZ>
          <cmz:mensaje/>
          <form id="frmDatos" name="frmDatos" action="unidadesMedidaEtiquetas" method="POST" target="_self">
            ...
            <cmz:panel>
              ...
              <cmz:cuerpoPanel>
	            <table cellpadding="2px" cellspacing="2px" border="0px">
	              <tr>
	                <td>Unidad medida etiqueta desde:</td>
	                <td>
	                	<cmz:ayuda nombreAyuda="UNIDADES_MEDIDAS_ETIQUETAS">
	                		<cmz:codigoAyuda idCodigo="codUnidadMedidaEtiqDesde" longitudMaximaCodigo="4" anchuraCodigo="40px"  />
	                		<cmz:descripcionAyuda idDescripcion="desUnidadMedidaEtiqDesde" anchuraDescripcion="150px"  />
	                	</cmz:ayuda>
	                </td>
				  </tr>	                
	              <tr>
	                <td>Unidad medida etiqueta hasta:</td>
	                <td>
	                	<cmz:ayuda nombreAyuda="UNIDADES_MEDIDAS_ETIQUETAS">
	                		<cmz:codigoAyuda idCodigo="codUnidadMedidaEtiqHasta" longitudMaximaCodigo="4" anchuraCodigo="40px"  />
	                		<cmz:descripcionAyuda idDescripcion="desUnidadMedidaEtiqHasta" anchuraDescripcion="150px"  />
	                	</cmz:ayuda>
	                </td>
				  </tr>
	            </table>  
