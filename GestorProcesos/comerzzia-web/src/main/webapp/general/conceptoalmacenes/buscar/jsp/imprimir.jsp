  ...
  <body onload="inicio();" >
    <cmz:main>
      <cmz:panelCMZ>
        ...
        <cmz:cuerpoPanelCMZ>
          <cmz:mensaje/>
          <form id="frmDatos" name="frmDatos" action="conceptoAlmacenes${paramBuscarConceptoAlmacenes.codAplicacion}" method="POST" target="_self">
            ...
            <cmz:panel>
              ...
              <cmz:cuerpoPanel>
	            <table cellpadding="2px" cellspacing="2px" border="0px">
	              <tr>
	                <td>Conceptos Almacenes desde:</td>
	                <td>
	                	<cmz:ayuda nombreAyuda="CONCEPTOS_ALMACENES_${paramBuscarConceptoAlmacenes.codAplicacion}">
	              ...
	              <tr>
	                <td>Conceptos Almacenes hasta:</td>
	                <td>
	                	<cmz:ayuda nombreAyuda="CONCEPTOS_ALMACENES_${paramBuscarConceptoAlmacenes.codAplicacion}">
