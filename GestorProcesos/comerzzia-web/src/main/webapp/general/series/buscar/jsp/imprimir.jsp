...
<html>
  <head>
    ...
    <script type="text/javascript">
	    function inicio() {
	        document.getElementById("codSerieDesde").focus();
	    }
	    function volver() {
	              ...
	              <tr>
	                ...
	                <td>
	                	<cmz:ayuda nombreAyuda="SERIES">
	                		<cmz:codigoAyuda idCodigo="codSerieDesde" longitudMaximaCodigo="5" anchuraCodigo="70px"  />
	                		<cmz:descripcionAyuda idDescripcion="desSerieDesde" anchuraDescripcion="200px"  />
	                	</cmz:ayuda>
	                </td>
				  </tr>	                
	              <tr>
	                ...
	                <td>
	                	<cmz:ayuda nombreAyuda="SERIES">
	                		<cmz:codigoAyuda idCodigo="codSerieHasta" longitudMaximaCodigo="5" anchuraCodigo="70px" />
	                		<cmz:descripcionAyuda idDescripcion="desSerieHasta" anchuraDescripcion="200px" />
	                	</cmz:ayuda>
	                </td>
				  </tr>
	              <tr>
