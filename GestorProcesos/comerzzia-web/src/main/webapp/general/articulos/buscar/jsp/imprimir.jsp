...
<html>
  <head>
    ...
    <script type="text/javascript">
	    function inicio() {
	        document.getElementById("codArticuloDesde").focus();
	    }
  ...
  <body onload="inicio();" >
    <cmz:main>
      <cmz:panelCMZ>
        ...
        <cmz:cuerpoPanelCMZ>
          <cmz:mensaje/>
          <form id="frmDatos" name="frmDatos" action="articulos" method="POST" target="_self">
              ...
              <cmz:cuerpoPanel>
	            <table cellpadding="2px" cellspacing="2px" border="0px">
	              <tr>
	                ...
	                <td>
	                	<cmz:ayuda nombreAyuda="ARTICULOS">
	                		<cmz:codigoAyuda idCodigo="codArticuloDesde" longitudMaximaCodigo="13" anchuraCodigo="110px"  />
	              ...
	              <tr>
	                ...
	                <td>
	                	<cmz:ayuda nombreAyuda="ARTICULOS">
	                		<cmz:codigoAyuda idCodigo="codArticuloHasta" longitudMaximaCodigo="13" anchuraCodigo="110px"  />
	              ...
	              <tr>
	                ...
	                <td>
	                	<cmz:ayuda nombreAyuda="FAMILIAS">
	                		...
	                		<cmz:descripcionAyuda idDescripcion="desFamiliaDesde" anchuraDescripcion="200px"  />
	                	</cmz:ayuda>
	                </td>
				  </tr>	                
	              <tr>
	                ...
	                <td>
	                	<cmz:ayuda nombreAyuda="FAMILIAS">
	                		...
	                		<cmz:descripcionAyuda idDescripcion="desFamiliaHasta" anchuraDescripcion="200px"  />
	                	</cmz:ayuda>
	                </td>
				  </tr>
	              <tr>
	                ...
	                <td>
	                	<cmz:ayuda nombreAyuda="PROVEEDORES">
	                		<cmz:codigoAyuda idCodigo="codProveedorDesde" longitudMaximaCodigo="11" anchuraCodigo="100px"  />
	                		<cmz:descripcionAyuda idDescripcion="desProveedorDesde" anchuraDescripcion="300px"  />
	                	</cmz:ayuda>
	                </td>
				  </tr>	                
	              <tr>
	                <td>Proveedor hasta:</td>
	                <td>
	                	<cmz:ayuda nombreAyuda="PROVEEDORES">
	                		<cmz:codigoAyuda idCodigo="codProveedorHasta" longitudMaximaCodigo="11" anchuraCodigo="100px"  />
	                		<cmz:descripcionAyuda idDescripcion="desProveedorHasta" anchuraDescripcion="300px"  />
	                	</cmz:ayuda>
	                </td>
				  </tr>
	              <tr>
