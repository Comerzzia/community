...
<html>
  <head>
    ...
    <script type="text/javascript">
	    function inicio() {
	        document.getElementById("codSeccionDesde").focus();
	    }
	    function volver() {
  ...
  <body onload="inicio();" >
    <cmz:main>
      <cmz:panelCMZ>
        ...
        <cmz:cuerpoPanelCMZ>
          <cmz:mensaje/>
          <form id="frmDatos" name="frmDatos" action="secciones" method="POST" target="_self">
              ...
              <cmz:cuerpoPanel>
	            <table cellpadding="2px" cellspacing="2px" border="0px">
	              <tr>
	                <td>Sección desde:</td>
	                <td>
	                	<cmz:ayuda nombreAyuda="SECCIONES">
	                		<cmz:codigoAyuda idCodigo="codSeccionDesde" longitudMaximaCodigo="4" anchuraCodigo="40px"  />
	                		<cmz:descripcionAyuda idDescripcion="desSeccionDesde" anchuraDescripcion="150px"  />
	                	</cmz:ayuda>
	                </td>
				  </tr>	                
	              <tr>
	                ...
	                <td>
	                	<cmz:ayuda nombreAyuda="SECCIONES">
	                		<cmz:codigoAyuda idCodigo="codSeccionHasta" longitudMaximaCodigo="4" anchuraCodigo="40px"  />
	                		<cmz:descripcionAyuda idDescripcion="desSeccionHasta" anchuraDescripcion="150px"  />
	                	</cmz:ayuda>
	                </td>
				  </tr>
	              <tr>
