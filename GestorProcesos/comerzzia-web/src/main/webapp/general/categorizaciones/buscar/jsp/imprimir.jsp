...
<html>
  <head>
    ...
    <script type="text/javascript">
	    function inicio() {
	        document.getElementById("codCategorizacionDesde").focus();
	    }
	    function volver() {
  ...
  <body onload="inicio();" >
    <cmz:main>
      <cmz:panelCMZ>
        ...
        <cmz:cuerpoPanelCMZ>
          <cmz:mensaje/>
          <form id="frmDatos" name="frmDatos" action="categorizaciones" method="POST" target="_self">
            ...
            <cmz:panel>
              ...
              <cmz:cuerpoPanel>
	            <table cellpadding="2px" cellspacing="2px" border="0px">
	              <tr>
	                <td>Categorización desde:</td>
	                <td>
	                	<cmz:ayuda nombreAyuda="CATEGORIZACIONES">
	                		<cmz:codigoAyuda idCodigo="codCategorizacionDesde" longitudMaximaCodigo="6" anchuraCodigo="100px"  />
	                		<cmz:descripcionAyuda idDescripcion="desCategorizacionDesde" anchuraDescripcion="300px"  />
	                	</cmz:ayuda>
	                </td>
				  </tr>	                
	              <tr>
	                <td>Categorización hasta:</td>
	                <td>
	                	<cmz:ayuda nombreAyuda="CATEGORIZACIONES">
	                		<cmz:codigoAyuda idCodigo="codCategorizacionHasta" longitudMaximaCodigo="6" anchuraCodigo="100px"  />
	                		<cmz:descripcionAyuda idDescripcion="desCategorizacionHasta" anchuraDescripcion="300px"  />
	                	</cmz:ayuda>
	                </td>
				  </tr>
	              <tr>
