...
<html>
  <head>
    ...
    <script type="text/javascript">
	    function inicio() {
	        document.getElementById("codPaisDesde").focus();
	    }
	    function volver() {
  ...
  <body onload="inicio();" >
    <cmz:main>
      <cmz:panelCMZ>
        ...
        <cmz:cuerpoPanelCMZ>
          <cmz:mensaje/>
          <form id="frmDatos" name="frmDatos" action="paises" method="POST" target="_self">
              ...
              <cmz:cuerpoPanel>
	            <table cellpadding="2px" cellspacing="2px" border="0px">
	              <tr>
	                <td>País desde:</td>
	                <td>
	                	<cmz:ayuda nombreAyuda="PAISES">
	                		<cmz:codigoAyuda idCodigo="codPaisDesde" longitudMaximaCodigo="4" anchuraCodigo="40px"  />
	                		<cmz:descripcionAyuda idDescripcion="desPaisDesde" anchuraDescripcion="180px"  />
	                	</cmz:ayuda>
	                </td>
				  </tr>	                
	              <tr>
	                ...
	                <td>
	                	<cmz:ayuda nombreAyuda="PAISES">
	                		<cmz:codigoAyuda idCodigo="codPaisHasta" longitudMaximaCodigo="4" anchuraCodigo="40px"  />
	                		<cmz:descripcionAyuda idDescripcion="desPaisHasta" anchuraDescripcion="180px"  />
	                	</cmz:ayuda>
	                </td>
				  </tr>
	              <tr>
