...
<html>
  <head>
    ...
    <script type="text/javascript">
	    function inicio() {
	        document.getElementById("codSecDesde").focus();
	    }
	    function volver() {
  ...
  <body onload="inicio();" >
    <cmz:main>
      <cmz:panelCMZ>
        ...
        <cmz:cuerpoPanelCMZ>
          <cmz:mensaje/>
          <form id="frmDatos" name="frmDatos" action="sectores" method="POST" target="_self">
            ...
            <cmz:panel>
              ...
              <cmz:cuerpoPanel>
	            <table cellpadding="2px" cellspacing="2px" border="0px">
	              <tr>
	                <td>Sectores desde:</td>
	                <td>
	                	<cmz:ayuda nombreAyuda="SECTORES">
	                		<cmz:codigoAyuda idCodigo="codSecDesde" longitudMaximaCodigo="4" anchuraCodigo="70px"  />
	                		<cmz:descripcionAyuda idDescripcion="desSecDesde" anchuraDescripcion="200px"  />
	                	</cmz:ayuda>
	                </td>
				  </tr>	                
	              <tr>
	                <td>Sectores hasta:</td>
	                <td>
	                	<cmz:ayuda nombreAyuda="SECTORES">
	                		<cmz:codigoAyuda idCodigo="codSecHasta" longitudMaximaCodigo="4" anchuraCodigo="70px" />
	                		<cmz:descripcionAyuda idDescripcion="desSecHasta" anchuraDescripcion="200px" />
	                	</cmz:ayuda>
	                </td>
				  </tr>
	              <tr>
