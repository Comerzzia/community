...
<html>
  <head>
    ...
    <script type="text/javascript">
	    function inicio() {
	        document.getElementById("codMedioPagoDesde").focus();
	    }
	    function volver() {
  ...
  <body onload="inicio();" >
    <cmz:main>
      <cmz:panelCMZ>
        ...
        <cmz:cuerpoPanelCMZ>
          <cmz:mensaje/>
          <form id="frmDatos" name="frmDatos" action="mediosPago" method="POST" target="_self">
            ...
            <cmz:panel>
              ...
              <cmz:cuerpoPanel>
	            <table cellpadding="2px" cellspacing="2px" border="0px">
	              <tr>
	                <td>Medio pago desde:</td>
	                <td>
	                	<cmz:ayuda nombreAyuda="MEDIOS_PAGO_VEN">
	                		<cmz:codigoAyuda idCodigo="codMedioPagoDesde" longitudMaximaCodigo="4" anchuraCodigo="70px"  />
	                		<cmz:descripcionAyuda idDescripcion="desMedioPagoDesde" anchuraDescripcion="200px"  />
	                	</cmz:ayuda>
	                </td>
				  </tr>	                
	              <tr>
	                <td>Medio pago hasta:</td>
	                <td>
	                	<cmz:ayuda nombreAyuda="MEDIOS_PAGO_VEN">
	                		<cmz:codigoAyuda idCodigo="codMedioPagoHasta" longitudMaximaCodigo="4" anchuraCodigo="70px" />
	                		<cmz:descripcionAyuda idDescripcion="desMedioPagoHasta" anchuraDescripcion="200px" />
	                	</cmz:ayuda>
	                </td>
				  </tr>
	              <tr>
