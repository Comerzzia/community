...
<html>
  <head>
    ...
    <script type="text/javascript">
	    function inicio() {
	        document.getElementById("codFamiliaDesde").focus();
	    }
	    function volver() {
	    ...
	    function imprimir(idVersion) {
	    	if(checkForm()) {
	            document.getElementById("accion").value = "general.familias.lstFamilias";
  ...
  <body onload="inicio();" >
    <cmz:main>
      <cmz:panelCMZ>
        ...
        <cmz:cuerpoPanelCMZ>
          <cmz:mensaje/>
          <form id="frmDatos" name="frmDatos" action="familias" method="POST" target="_self">
