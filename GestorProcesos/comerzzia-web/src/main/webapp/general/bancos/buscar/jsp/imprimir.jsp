...
<html>
  <head>
    ...
    <script type="text/javascript">
	    function inicio() {
	        document.getElementById("codBancoDesde").focus();
	    }
	    function volver() {
  ...
  <body onload="inicio();" >
    <cmz:main>
      <cmz:panelCMZ>
        ...
        <cmz:cuerpoPanelCMZ>
          <cmz:mensaje/>
          <form id="frmDatos" name="frmDatos" action="bancos" method="POST" target="_self">
	              ...
	              <tr>
	                ...
	                <td>
	                	<cmz:ayuda nombreAyuda="BANCOS">
	                		<cmz:codigoAyuda idCodigo="codBancoDesde" longitudMaximaCodigo="11" anchuraCodigo="100px"  />
	                		<cmz:descripcionAyuda idDescripcion="desBancoDesde" anchuraDescripcion="300px"  />
	                	</cmz:ayuda>
	                </td>
				  </tr>	                
	              <tr>
	                ...
	                <td>
	                	<cmz:ayuda nombreAyuda="BANCOS">
	                		<cmz:codigoAyuda idCodigo="codBancoHasta" longitudMaximaCodigo="11" anchuraCodigo="100px"  />
	                		<cmz:descripcionAyuda idDescripcion="desBancoHasta" anchuraDescripcion="300px"  />
	                	</cmz:ayuda>
	                </td>
				  </tr>
	              <tr>
