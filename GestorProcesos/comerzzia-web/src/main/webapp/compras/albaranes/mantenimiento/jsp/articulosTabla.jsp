  ...
  <cmz:cuerpoPanel>
    <cmz:lista>
      <cmz:cabeceraLista>
        ...
        <c:if test="${!empty formularioAlbaranCompra.tituloDesglose1}">
          <cmz:itemCabeceraLista nombre="${formularioAlbaranCompra.tituloDesglose1}"></cmz:itemCabeceraLista>
        </c:if>
        <c:if test="${!empty formularioAlbaranCompra.tituloDesglose2}">
          <cmz:itemCabeceraLista nombre="${formularioAlbaranCompra.tituloDesglose2}"></cmz:itemCabeceraLista>
        </c:if>
      ...
      <cmz:contenidoListaIndexada variable="articulo" lista="${formularioAlbaranCompra.formularioPestañaActiva.registros}">
