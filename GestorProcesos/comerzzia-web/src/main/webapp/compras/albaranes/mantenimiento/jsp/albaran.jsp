...
<jsp:useBean id="formularioAlbaranCompra" type="com.comerzzia.web.compras.albaranes.ui.FormularioAlbaranCompraBean" scope="session" />
  ...
  <head>
    ...
    <script type="text/javascript">
	    ...
	    function inicio() {
        	...
        	<c:if test="${(formularioAlbaranCompra.pestañaActiva == 0) && (formularioAlbaranCompra.editable)}">
        ...
        function imprimir(){
            document.getElementById("accion").value = "compras.albaranes.infAlbaranCompras";
      ...
      <cmz:panelCMZ>
        <cmz:cabeceraPanelCMZ titulo="${permisos.accionMenu.titulo}" icono="${permisos.accionMenu.icono}">
          <cmz:acciones numAccionesVisibles="3">
            <c:choose>
              <c:when test="${!formularioAlbaranCompra.editable}">
        ...
        <cmz:cuerpoPanelCMZ>
          ...
          <form id="frmDatos" name="frmDatos" action="albaranesCompras" method="post">
            ...
            <cmz:pestañas>
              <cmz:cabeceraPestañas pestañaActiva="${formularioAlbaranCompra.pestañaActiva}">
              ...
              <cmz:cuerpoPestaña>
                <c:choose>
                  <c:when test="${formularioAlbaranCompra.pestañaActiva == 1}">
                    <c:choose>
                      <c:when test="${formularioAlbaranCompra.formularioPestañaActiva.modoVisualizacionFicha}">
                  ...
                  <c:when test="${formularioAlbaranCompra.pestañaActiva == 2}">
                    <c:choose>
                      <c:when test="${formularioAlbaranCompra.formularioPestañaActiva.modoVisualizacionFicha}">
                  ...
                  <c:when test="${formularioAlbaranCompra.pestañaActiva == 3}">
