...
<c:set var="articulo" value="${formularioAlbaranCompra.formularioPestañaActiva.registroActivo}" />
...
<cmz:panel>
    ...
    <cmz:acciones>
      <c:choose>
        ...
        <c:otherwise>
          ...
          <c:if test="${formularioAlbaranCompra.editable}">
  ...
  <input type="hidden" id="signo" name="signo" value="${requestScope.signo}"/> 
  <cmz:cuerpoPanel>
    <table cellpadding="2px" cellspacing="2px" border="0px">
      ...
      <c:choose>
        <c:when test="${empty formularioAlbaranCompra.tituloDesglose1}">
          <input name="desglose1" id="desglose1" type="hidden" value="*" />
        </c:when>
        <c:otherwise>
          <tr>
            <td><c:out value="${formularioAlbaranCompra.tituloDesglose1}" />:</td>
            <td>
              <c:choose>
              	<c:when test="${formulario.editable}">
      ...
      <c:choose>
        <c:when test="${empty formularioAlbaranCompra.tituloDesglose2}">
          <input name="desglose2" id="desglose2" type="hidden" value="*" />
        </c:when>
        <c:otherwise>
          <tr>
            <td><c:out value="${formularioAlbaranCompra.tituloDesglose2}" />:</td>
            <td>
              <c:choose>
              	<c:when test="${formulario.editable}">
      ...
      <tr>
        ...
        <td>
          <cmz:campoTexto id="cantidadMedida" requerido="false" soloLectura="${!formulario.editable}" onChange="calcularUnidades();" anchura="70px">
          	<cmz:formateaNumero valor="${articulo.cantidadMedida}"></cmz:formateaNumero>
          </cmz:campoTexto>
      ...
      <tr>
        ...
        <td>
          <cmz:campoTexto id="cantidad" requerido="true" editable="${formulario.editable}" soloLectura="${!formulario.editable}" onChange="calcularImporte();" anchura="70px">
			<cmz:formateaNumero valor="${articulo.cantidad}"></cmz:formateaNumero>
          </cmz:campoTexto>
        </td>
      </tr>
      ...
      <tr>
        ...
        <td>
          <cmz:campoTexto id="precio" requerido="true" editable="${formulario.editable}" soloLectura="${!formulario.editable}" onChange="calcularImporte();" anchura="70px">
			<cmz:formateaNumero valor="${articulo.precio}"></cmz:formateaNumero>
          </cmz:campoTexto>
        </td>
      </tr>
      ...
      <tr>
        ...
        <td>
          <cmz:campoTexto id="descuento" requerido="false" editable="${formulario.editable}" soloLectura="${!formulario.editable}" onChange="calcularImporte();" anchura="70px">
			<cmz:formateaNumero valor="${articulo.descuento}"></cmz:formateaNumero>
          </cmz:campoTexto> %
        </td>
      </tr>
      ...
      <tr>
        ...
        <td>
          <cmz:campoTexto id="importe" editable="false" soloLectura="true" anchura="90px">
			<cmz:formateaNumero numDecimales="2" valor="${articulo.importe}"></cmz:formateaNumero>
          </cmz:campoTexto>
        </td>
      </tr>
