  ...
  <cmz:cuerpoPanel>
	<table cellpadding="2px" cellspacing="2px" border="0px">
      <tr>
        ...
        <td><cmz:campoTexto id="desTratamientoImpuestos" valor="${pedido.desTratamientoImpuestos}" anchura="200px" soloLectura="true" /></td>
      </tr>
	</table>
    ...
    <cmz:lista>
      <cmz:cabeceraLista>
        ...
        <cmz:itemCabeceraLista nombre="Porcentaje" estilo="text-align: center;"></cmz:itemCabeceraLista>
      ...
      <cmz:contenidoLista variable="impuesto" lista="${pedido.detalleImpuestos.listaImpuestos}">
        <c:set var="porcentajeImpuesto" value="${pedido.porcentajesImpuestos.porcentajesImpuestos[impuesto.codImpuesto]}" />
        <c:choose>
        ...
        <cmz:itemContenidoLista alineacion="center"><cmz:formateaNumero valor="${porcentajeImpuesto.porcentaje}"/>&nbsp;%&nbsp;<c:out value="${porcentajeRecargo}" /></cmz:itemContenidoLista>
