  ...
  <head>
    ...
    <script type="text/javascript">
	    ...
	    function checkForm() {
	    	...
	    	if(!esValido("codConceptoAlmacenDesde", "AYUDA", false, "desConceptoAlmacenDesde", "CONCEPTOS_ALMACENES_COMP")) {
				return false;
			}
	    	if(!esValido("codConceptoAlmacenHasta", "AYUDA", false, "desConceptoAlmacenHasta", "CONCEPTOS_ALMACENES_COMP")) {
				return false;
			}
	    	...
	    	if(!esValido("codProveedorDesde", "AYUDA", false, "desProveedorDesde", "PROVEEDORES")) {
				return false;
			}
	    	if(!esValido("codProveedorHasta", "AYUDA", false, "desProveedorHasta", "PROVEEDORES")) {
				return false;
			}
  ...
  <body onload="inicio();" >
    <cmz:main>
      <cmz:panelCMZ>
        ...
        <cmz:cuerpoPanelCMZ>
          <cmz:mensaje/>
          <form id="frmDatos" name="frmDatos" action="pedidosCompras" method="POST" target="_self">
              ...
              <cmz:cuerpoPanel>
	            <table cellpadding="2px" cellspacing="2px" border="0px">
	              ...
	              <tr>
	                ...
	                <td>
			          <cmz:ayuda nombreAyuda="PROVEEDORES">
			            <cmz:codigoAyuda idCodigo="codProveedorDesde" longitudMaximaCodigo="11" anchuraCodigo="90px"/>
	              ...
	              <tr>
	                ...
	                <td>
			          <cmz:ayuda nombreAyuda="PROVEEDORES">
			            <cmz:codigoAyuda idCodigo="codProveedorHasta" longitudMaximaCodigo="11" anchuraCodigo="90px"/>
