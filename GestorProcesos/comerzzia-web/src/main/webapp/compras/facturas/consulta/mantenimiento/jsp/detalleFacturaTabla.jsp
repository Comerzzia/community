	...
	<cmz:cuerpoPanel>
		<cmz:lista>
			<cmz:cabeceraLista>
				...
				<c:if test="${!empty formularioFacturaCompra.tituloDesglose1}">
				<cmz:itemCabeceraLista nombre="${formularioFacturaCompra.tituloDesglose1}"></cmz:itemCabeceraLista>
				</c:if>
				<c:if test="${!empty formularioFacturaCompra.tituloDesglose2}">
				<cmz:itemCabeceraLista nombre="${formularioFacturaCompra.tituloDesglose2}"></cmz:itemCabeceraLista>
				</c:if>
			...
			<cmz:contenidoListaIndexada variable="detalle" lista="${formularioFacturaCompra.formularioPestañaActiva.registros}">
