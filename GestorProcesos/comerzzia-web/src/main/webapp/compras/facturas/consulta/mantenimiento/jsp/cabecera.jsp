                ...
                <table cellpadding="2px" cellspacing="2px" border="0px">
                  ...
                  <tr>
                    ...
                    <td><cmz:campoTexto id="domicilio" valor="${factura.domicilio}" requerido="false" anchura="300px" longitudMaxima="50" 
                                        editable="${formularioFacturaCompra.editable}" soloLectura="${!formularioFacturaCompra.editable}"/></td>
                  </tr>
                  <tr>
                    <td>Población:</td>
            ...
            <table cellpadding="2px" cellspacing="2px" border="0px">
                 <tr>
					...
					<td><c:set var="fechaFacturaProveedor"><fmt:formatDate pattern="dd/MM/yyyy" value="${factura.fechaFacturaProveedor}" /></c:set> 
						<cmz:campoTexto id="fechaFacturaProveedor" valor="${fechaFacturaProveedor}" editable="${formularioFacturaCompra.enInsercion}" 
							soloLectura="${!formularioFacturaCompra.enInsercion}" requerido="false" anchura="65" />
					</td>
					<td align="right">Nº factura del proveedor:</td>
					<td><cmz:campoTexto id="referencia" valor="${factura.referencia}" requerido="false" editable="${formularioFacturaCompra.enInsercion}" 
							soloLectura="${!formularioFacturaCompra.enInsercion}" anchura="100px" longitudMaxima="50"/></td>
				  </tr>
				  <tr>
					<td>Concepto:</td>
					<td><cmz:campoTexto id="concepto" valor="${factura.concepto}" requerido="false" editable="${formularioFacturaCompra.enInsercion}" 
							soloLectura="${!formularioFacturaCompra.enInsercion}" anchura="250px" longitudMaxima="50"/></td>
				  </tr>
				  <tr>
					<td>Serie de la factura:</td>
					<td colspan="3"><cmz:ayuda nombreAyuda="SERIES" requerido="false" soloLectura="${!formularioFacturaCompra.enInsercion}">
