  ...
  <head>
    ...
    <script type="text/javascript">
	    ...
	    function imprimir(idVersion) {
	    	if(checkForm()) {
	            document.getElementById("accion").value = "compras.estadisticas.lstSituacionCompras";
  ...
  <body onload="inicio();" >
    <cmz:main>
      <cmz:panelCMZ>
        ...
        <cmz:cuerpoPanelCMZ>
          <cmz:mensaje/>
          <form id="frmDatos" name="frmDatos" action="estadisticasCompras" method="POST" target="_self">
	              ...
	              <tr>
	                ...
	                <td>
	                	<cmz:ayuda nombreAyuda="PROVEEDORES">
	                		<cmz:codigoAyuda idCodigo="codProDesde" longitudMaximaCodigo="11" anchuraCodigo="100px"  />
	                		<cmz:descripcionAyuda idDescripcion="desProDesde" anchuraDescripcion="320px"  />
	                	</cmz:ayuda>
	                </td>
				  </tr>	                
	              <tr>
	                ...
	                <td>
	                	<cmz:ayuda nombreAyuda="PROVEEDORES">
	                		<cmz:codigoAyuda idCodigo="codProHasta" longitudMaximaCodigo="11" anchuraCodigo="100px" />
	                		<cmz:descripcionAyuda idDescripcion="desProHasta" anchuraDescripcion="320px" />
	                	</cmz:ayuda>
	                </td>
				  </tr>
