...
<html>
  <head>
    ...
    <script type="text/javascript">
	    function inicio() {
	        document.getElementById("codAlmacenDesde").focus();
	    }
	    function volver() {
  ...
  <body onload="inicio();" >
    <cmz:main>
      <cmz:panelCMZ>
        ...
        <cmz:cuerpoPanelCMZ>
          <cmz:mensaje/>
          <form id="frmDatos" name="frmDatos" action="regularizaciones" method="POST" target="_self">
	              ...
	              <tr>
	                ...
	                <td>
	                	<cmz:ayuda nombreAyuda="ALMACENES">
	                		<cmz:codigoAyuda idCodigo="codAlmacenDesde" longitudMaximaCodigo="5" anchuraCodigo="70px"  />
	                		<cmz:descripcionAyuda idDescripcion="desAlmacenDesde" anchuraDescripcion="200px"  />
	                	</cmz:ayuda>
	                </td>
				  </tr>	                
	              <tr>
	                ...
	                <td>
	                	<cmz:ayuda nombreAyuda="ALMACENES">
	                		<cmz:codigoAyuda idCodigo="codAlmacenHasta" longitudMaximaCodigo="5" anchuraCodigo="70px" />
	                		<cmz:descripcionAyuda idDescripcion="desAlmacenHasta" anchuraDescripcion="200px" />
	                	</cmz:ayuda>
	                </td>
				  </tr>
				  <tr>
	                <td>Concepto desde:</td>
	                <td>
	                	<cmz:ayuda nombreAyuda="CONCEPTOS_ALMACENES_REGU">
	                		<cmz:codigoAyuda idCodigo="codConceptoAlmacenDesde" longitudMaximaCodigo="5" anchuraCodigo="70px"  />
	                		<cmz:descripcionAyuda idDescripcion="desConceptoAlmacenDesde" anchuraDescripcion="200px"  />
	                	</cmz:ayuda>
	                </td>
				  </tr>	                
	              <tr>
	                <td>Concepto hasta:</td>
	                <td>
	                	<cmz:ayuda nombreAyuda="CONCEPTOS_ALMACENES_REGU">
	                		<cmz:codigoAyuda idCodigo="codConceptoAlmacenHasta" longitudMaximaCodigo="5" anchuraCodigo="70px" />
	                		<cmz:descripcionAyuda idDescripcion="desConceptoAlmacenHasta" anchuraDescripcion="200px" />
	                	</cmz:ayuda>
	                </td>
				  </tr>
				  <tr>
	                <td>Fecha desde:</td>
	                <td>
	                	<c:set var="fechaDesde"><fmt:formatDate pattern="dd/MM/yyyy" value="${paramBuscarRegularizaciones.fechaDesde}"/></c:set>
	                	<cmz:campoFecha id="fechaDesde" valor="${fechaDesde}" mostrarCheckbox="false" />
	                </td>
				  </tr>	                
	              <tr>
	                <td>Fecha hasta:</td>
	                <td>
	                	<c:set var="fechaHasta"><fmt:formatDate pattern="dd/MM/yyyy" value="${paramBuscarRegularizaciones.fechaHasta}"/></c:set>
	                	<cmz:campoFecha id="fechaHasta" valor="${fechaHasta}" mostrarCheckbox="false" />
	                </td>
				  </tr>
	              <tr>
