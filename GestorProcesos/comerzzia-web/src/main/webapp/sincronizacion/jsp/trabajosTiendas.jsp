...
<c:forEach items="${formularioSincronizacion.formularioPestañaActiva.registros}" var="listaTrabajos">
  <cmz:panel>
    <cmz:cabeceraPanel titulo="Tienda ${listaTrabajos.titulo}"></cmz:cabeceraPanel>
  	<cmz:cuerpoPanel>
      <cmz:lista>
        <cmz:cabeceraLista>
          <cmz:itemCabeceraLista nombre="Trabajo"></cmz:itemCabeceraLista>
        ...
        <cmz:contenidoLista variable="trabajo" lista="${listaTrabajos.listaTrabajos}">
          <cmz:itemContenidoLista valor="${trabajo.trabajo}" onclick="verTrabajo('${trabajo.idTrabajo}');"></cmz:itemContenidoLista>
