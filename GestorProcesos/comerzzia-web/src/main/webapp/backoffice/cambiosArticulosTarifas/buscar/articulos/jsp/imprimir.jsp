      ...
      <cmz:panelCMZ>
        ...
        <cmz:cuerpoPanelCMZ>
          ...
          <form id="frmDatos" name="frmDatos" action="cambiosArticulosTarifas" method="POST" target="_self">
            ...
            <input id="versionArticulosRev" name="versionArticulosRev" type="hidden" value="${param.versionArticulosRev}" />
            <input id="fechaVersionArticulosRev" name="fechaVersionArticulosRev" type="hidden" value="${param.fechaVersionArticulosRev}" />
