...
<html>
  <head>
    ...
    <script type="text/javascript">
	    ...
	    function volver() {
	    	document.getElementById("accion").value = "buscarCambiosArticulosTarifas";
  ...
  <body>
    <cmz:main>
      <cmz:panelCMZ>
        ...
        <cmz:cuerpoPanelCMZ>
          <cmz:mensaje/>
          <form id="frmDatos" name="frmDatos" action="cambiosArticulosTarifas" method="POST" target="_self">
            <input id="accion" name="accion" type="hidden" value="" />
            <input id="operacion" name="operacion" type="hidden" value="" />
            <input id="idVersion" name="idVersion" type="hidden" value="0" />
            <input id="codAlm" name="codAlm" type="hidden" value="${param.codAlm}" />
            <input id="codTarifa" name="codTarifa" type="hidden" value="${param.codTarifa}" />
            <input id="versionTarifaRev" name="versionTarifaRev" type="hidden" value="${param.versionTarifaRev}" />
            <input id="fechaVersionTarifaRev" name="fechaVersionTarifaRev" type="hidden" value="${param.fechaVersionTarifaRev}" />
