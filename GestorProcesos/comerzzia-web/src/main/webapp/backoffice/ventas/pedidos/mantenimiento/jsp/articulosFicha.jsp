...
<c:set var="campoEditable" value="${formulario.editable && pedido.estaSolicitud}" />
    ...
    function validarArticulo() {
        ...
        if (response != null) {
            if (response.getElementsByTagName("ERROR").item(0)) {
                ...
                // Obtener el precio de costo ya que el cliente es una tienda
...
<cmz:panel>
  ...
  <cmz:cuerpoPanel>
    <table cellpadding="2px" cellspacing="2px" border="0px">
      ...
      <c:choose>
        <c:when test="${empty formularioPedidoVentaBackoffice.tituloDesglose1}">
          <input name="desglose1" id="desglose1" type="hidden" value="*" />
        </c:when>
        <c:otherwise>
          <tr>
            <td><c:out value="${formularioPedidoVentaBackoffice.tituloDesglose1}" />:</td>
            <td colspan="3">
              <c:choose>
      ...
      <c:choose>
        <c:when test="${empty formularioPedidoVentaBackoffice.tituloDesglose2}">
          <input name="desglose2" id="desglose2" type="hidden" value="*" />
        </c:when>
        <c:otherwise>
          <tr>
            <td><c:out value="${formularioPedidoVentaBackoffice.tituloDesglose2}" />:</td>
            <td colspan="3">
              <c:choose>
              	<c:when test="${campoEditable}">
      ...
      <tr>
        ...
        <td colspan="3">
          <cmz:campoTexto id="precio" requerido="true" editable="false" soloLectura="true" onChange="calcularImporte();" anchura="70px">
      ...
      <tr>
        ...
        <c:out value="${sangria}" escapeXml="false" />
        <td colspan="3">
          <cmz:campoTexto id="descuento" requerido="false" editable="false" soloLectura="true" onChange="calcularImporte();" anchura="70px">
