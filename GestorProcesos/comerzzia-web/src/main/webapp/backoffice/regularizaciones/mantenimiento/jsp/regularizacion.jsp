...
<jsp:useBean id="formularioRegularizacionBackoffice" type="com.comerzzia.web.backoffice.regularizaciones.ui.FormularioRegularizacionBackofficeBean" scope="session" />
<jsp:useBean id="permisos" class="com.comerzzia.servicios.core.permisos.PermisosEfectivosAccionBean" scope="request" />

<c:set var="regularizacion" value="${formularioRegularizacionBackoffice.registroActivo}" />
    ...
    <script type="text/javascript">
        function inicio() {
        	...
        	if(document.getElementById("codArticulo").value > 0) {
                <c:if test="${formularioRegularizacionBackoffice.editable}">
                    validarArticulo();
                </c:if>
          	}
        ...
        function validarConceptoAlmacen() {
            ...
            var url = "conceptoAlmacenRegularizacionBackoffice.cmz" +
        ...
        function ayudaConceptoAlmacen() {
        	var rt = buscar('CONCEPTOS_ALMACENES_BACKOFFICE_REGU','codConceptoAlmacen', 'desConceptoAlmacen');
      ...
      <cmz:panelCMZBackoffice>
        <cmz:cabeceraPanelCMZ titulo="${permisos.accionMenu.titulo}" icono="${permisos.accionMenu.icono}">
          <cmz:acciones numAccionesVisibles="2">
            <c:choose>
              <c:when test="${!formularioRegularizacionBackoffice.editable}">
        ...
        <cmz:cuerpoPanelCMZ>
          <cmz:mensaje/>
          <form id="frmDatos" name="frmDatos" action="regularizacionesTienda" method="post">
              ...
              <cmz:cuerpoPanel>
                <table cellpadding="2px" cellspacing="2px" border="0px">
                  <tr>
                    ...
                    <td>
                      <cmz:ayuda requerido="true" soloLectura="${!formularioRegularizacionBackoffice.editable}" nombreAyuda="CONCEPTOS_ALMACENES_BACKOFFICE_REGU" onclick="ayudaConceptoAlmacen();">
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <cmz:campoFecha id="fecha" valor="${fecha}" mostrarCheckbox="false" requerido="true" editable="${formularioRegularizacionBackoffice.editable}" soloLectura="${!formularioRegularizacionBackoffice.editable}"/>
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td>Artículo:</td>
                    <td>
                        <cmz:ayuda requerido="true" soloLectura="${!formularioRegularizacionBackoffice.editable}" nombreAyuda="ARTICULOS" onclick="ayudaArticulos();">
                  ...
                  <c:choose>
			        <c:when test="${empty formularioRegularizacionBackoffice.tituloDesglose1}">
			          <input name="desglose1" id="desglose1" type="hidden" value="*" />
			        </c:when>
			        <c:otherwise>
			          <tr>
			            <td><c:out value="${formularioRegularizacionBackoffice.tituloDesglose1}" />:</td>
			            <td>
			              <c:choose>
			              	<c:when test="${formularioRegularizacionBackoffice.editable}">
				              <cmz:campoTexto id="desglose1" valor="${regularizacion.desglose1}" requerido="true" editable="${formularioRegularizacionBackoffice.editable}" soloLectura="true" longitudMaxima="15" anchura="120px" clase="campo soloLectura requerido"></cmz:campoTexto>
			              	...
			              	<c:otherwise>
				              <cmz:campoTexto id="desglose1" valor="${regularizacion.desglose1}" requerido="true" editable="${formularioRegularizacionBackoffice.editable}" soloLectura="true" longitudMaxima="15" anchura="120px"></cmz:campoTexto>
			              	</c:otherwise>
			              </c:choose>	
			            </td>
			          </tr>
			      ...
			      <c:choose>
			        <c:when test="${empty formularioRegularizacionBackoffice.tituloDesglose2}">
			          <input name="desglose2" id="desglose2" type="hidden" value="*" />
			        </c:when>
			        <c:otherwise>
			          <tr>
			            <td><c:out value="${formularioRegularizacionBackoffice.tituloDesglose2}" />:</td>
			            <td>
			              <c:choose>
			              	<c:when test="${formularioRegularizacionBackoffice.editable}">
				              <cmz:campoTexto id="desglose2" valor="${regularizacion.desglose2}" requerido="true" editable="${formularioRegularizacionBackoffice.editable}" soloLectura="true" longitudMaxima="15" anchura="120px" clase="campo soloLectura requerido"></cmz:campoTexto>
			              	  <img src="comun/images/iconos/desplegable.gif" class="prismaticos" align="absMiddle" border="0" valign="middle"  onClick="buscarDesglosesArticulo();"  WIDTH="16" HEIGHT="16"/>	
			              	</c:when>
			              	<c:otherwise>
				              <cmz:campoTexto id="desglose2" valor="${regularizacion.desglose2}" requerido="true" editable="${formularioRegularizacionBackoffice.editable}" soloLectura="true" longitudMaxima="15" anchura="120px"></cmz:campoTexto>
			              	</c:otherwise>
			              </c:choose>	
			            </td>
			          </tr>
                  ...
                  <tr>
                    <td>Cantidad:</td>
                    <td>
                      <cmz:campoTexto id="cantidadMedida" anchura="90px" longitudMaxima="13" editable="${formularioRegularizacionBackoffice.editable}" soloLectura="${!formularioRegularizacionBackoffice.editable}" onChange="calcularUnidades();">
                  ...
                  <tr>
                    <td>Unidades:</td>
                    <td>
                      <cmz:campoTexto id="cantidad" anchura="90px" longitudMaxima="13" requerido="true" editable="${formularioRegularizacionBackoffice.editable}" soloLectura="${!formularioRegularizacionBackoffice.editable}" onChange="calcularImporte();">
                  ...
                  <tr>
                    <td>Precio:</td>
                    <td>
                      <cmz:campoTexto id="precio" anchura="90px" longitudMaxima="14" requerido="true" editable="${formularioRegularizacionBackoffice.editable}" soloLectura="${!formularioRegularizacionBackoffice.editable}" onChange="calcularImporte();">
            ...
            <cmz:panel>
  			  ...
  			  <cmz:cuerpoPanel>
    			<cmz:campoAreaTexto id="observaciones" anchura="100%" altura="100px" valor="${regularizacion.observaciones}" editable="${formularioRegularizacionBackoffice.editable}"
    			soloLectura="${!formularioRegularizacionBackoffice.editable}" longitudMaxima="255"></cmz:campoAreaTexto>
  			  </cmz:cuerpoPanel>
			</cmz:panel> 
