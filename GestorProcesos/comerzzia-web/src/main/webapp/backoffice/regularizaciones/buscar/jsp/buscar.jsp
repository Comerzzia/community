...
<jsp:useBean id="paramBuscarRegularizacionesBackoffice" type="com.comerzzia.persistencia.almacenes.regularizaciones.ParametrosBuscarRegularizacionesBean" scope="session" />
                      ...
                      <table cellpadding="2px" cellspacing="2px" border="0px">
                        <tr>
                          ...
                          <cmz:ayuda requerido="false" soloLectura="false" nombreAyuda="ARTICULOS">
          					<cmz:codigoAyuda idCodigo="codArticulo" valorCodigo="${paramBuscarRegularizacionesBackoffice.codArticulo}" anchuraCodigo="90px" longitudMaximaCodigo="13"></cmz:codigoAyuda>
          					<cmz:descripcionAyuda idDescripcion="desArticulo" valorDescripcion="${paramBuscarRegularizacionesBackoffice.desArticulo}" anchuraDescripcion="300px"></cmz:descripcionAyuda>
          				  </cmz:ayuda>
                          </td>
                        ...
                        <tr>
                          <td>Concepto:</td>
                          <td>
                          	<cmz:ayuda requerido="true" soloLectura="false" nombreAyuda="CONCEPTOS_ALMACENES_BACKOFFICE_REGU">
          					  <cmz:codigoAyuda idCodigo="codConceptoAlmacen" valorCodigo="${paramBuscarRegularizacionesBackoffice.codConceptoAlmacen}" anchuraCodigo="40px" longitudMaximaCodigo="4"></cmz:codigoAyuda>
          					  <cmz:descripcionAyuda idDescripcion="desConceptoAlmacen" valorDescripcion="${paramBuscarRegularizacionesBackoffice.desConceptoAlmacen}" anchuraDescripcion="300px"></cmz:descripcionAyuda>
          				  	</cmz:ayuda>
                          </td>
                        </tr>
                        <tr>
                          <td>Fecha:</td>
                          <td>
						    <c:set var="fecha"><fmt:formatDate  pattern="dd/MM/yyyy" value="${paramBuscarRegularizacionesBackoffice.fecha}"/></c:set>
            ...
            <c:choose>
              <c:when test="${paginaResultados.pagina != null}">
                <cmz:panel>
                  ...
                  <cmz:cuerpoPanel>
                    <cmz:listaPaginada>
                      <cmz:cabeceraListaPaginada ordenActual="${paramBuscarRegularizacionesBackoffice.orden}">
                        ...
                        <c:if test="${!empty formularioRegularizacionBackoffice.tituloDesglose1}">
          					<cmz:itemCabeceraListaPaginada nombre="${formularioRegularizacionBackoffice.tituloDesglose1}" columna="3" ordenColumna="DESGLOSE1"></cmz:itemCabeceraListaPaginada>
        				</c:if>
        				<c:if test="${!empty formularioRegularizacionBackoffice.tituloDesglose2}">
          					<cmz:itemCabeceraListaPaginada nombre="${formularioRegularizacionBackoffice.tituloDesglose2}" columna="4" ordenColumna="DESGLOSE2"></cmz:itemCabeceraListaPaginada>
       	 				</c:if>
