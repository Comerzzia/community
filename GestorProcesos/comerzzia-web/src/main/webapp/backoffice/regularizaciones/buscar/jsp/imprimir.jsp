  ...
  <body onload="inicio();" >
    <cmz:main>
      <cmz:panelCMZ>
        ...
        <cmz:cuerpoPanelCMZ>
          <cmz:mensaje/>
          <form id="frmDatos" name="frmDatos" action="regularizacionesTienda" method="POST" target="_self">
              ...
              <cmz:cuerpoPanel>
	            <table cellpadding="2px" cellspacing="2px" border="0px">
	              <tr>
	                ...
	                <td>
	                	<cmz:ayuda nombreAyuda="CONCEPTOS_ALMACENES_BACKOFFICE_REGU">
				  ...
				  <tr>
	                <td>Fecha desde:</td>
	                <td>
	                	<c:set var="fechaDesde"><fmt:formatDate pattern="dd/MM/yyyy" value="${paramBuscarRegularizacionesBackoffice.fechaDesde}"/></c:set>
	              ...
	              <tr>
	                <td>Fecha hasta:</td>
	                <td>
	                	<c:set var="fechaHasta"><fmt:formatDate pattern="dd/MM/yyyy" value="${paramBuscarRegularizacionesBackoffice.fechaHasta}"/></c:set>
