...
<c:set var="tratamientoPagos" value="${formularioRemesaPago.tratamientoPagos}" />
  ...
  <head>
    ...
    <script type="text/javascript">
        ...
        function checkForm() {
        	...
        	if(!esValido("codSerie", "AYUDA", false, "desSerie", "SERIES")) {
    			return false;
    		}
        	if (!esValido("documento", "TEXTO", true)) {
                return false;
            }
        	if (!esValido("importe", "NUMERICO", true, 2)) {
                return false;
            }
        ...
        function agregarDocumento() {
        	if(checkForm()) {
              document.getElementById("accion").value = "añadirDocumento";
              document.getElementById("frmDatos").submit();
          	  _esperando();
           }
        }
                  ...
                  <cmz:cuerpoPanel>
                    <table cellpadding="2px" cellspacing="2px" border="0px" width="100%">
                      <tr>
                       <td>Vencimiento:</td>
                        <td>
                          <cmz:campoFecha id="fechaVencimiento" requerido="true" editable="true">
                            <fmt:formatDate pattern="dd/MM/yyyy" value="${documentoPago.fechaVencimiento}"/>
                          </cmz:campoFecha>
                        </td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td>
                          <cmz:ayuda nombreAyuda="SERIES">
                            <cmz:codigoAyuda idCodigo="codSerie" valorCodigo="${documentoPago.codSerie}" longitudMaximaCodigo="5" anchuraCodigo="45px"/>
                            <cmz:descripcionAyuda idDescripcion="desSerie" valorDescripcion="${documentoPago.desSerie}" anchuraDescripcion="300px"  />
                          </cmz:ayuda>
                        </td>
                      </tr>
                      ...
                      <tr>
                        <td>Documento:</td>
                        <td>
                          <cmz:campoTexto id="documento" valor="${documentoPago.documento}" requerido="true" longitudMaxima="20" anchura="100px"/>
                        </td>
                      </tr>
                      ...
                      <tr>
                       <td>Importe:</td>
                        <td>
                          <cmz:campoTexto id="importe" requerido="true" longitudMaxima="14" anchura="70">
                      ...
                      <tr>
                        <td>Tipo efecto:</td>
                        <td>
                          <cmz:ayuda nombreAyuda="TIPOSEFECTOS" onclick="ayudaTiposEfectos()" requerido="true">
                            ...
                            <cmz:descripcionAyuda idDescripcion="desTipoEfecto" valorDescripcion="${documentoPago.desTipoEfecto}" anchuraDescripcion="200px"  />
                          </cmz:ayuda>
                        </td>
                      </tr>
              ...
              <cmz:cuerpoPanel>
                <table cellpadding="0px" cellspacing="0px" border="0px" width="100%">
                  <tr>
                    ...
                    <td>
                      <cmz:campoTexto id="importeMarcados" editable="false" soloLectura="true" longitudMaxima="13" anchura="100">
                      	<cmz:formateaNumero valor="${tratamientoPagos.importeMarcado}"/>
                      </cmz:campoTexto>
                    </td>
                    <td width="150px">Importe nuevos vencimientos:</td>
                    <td>
                      <cmz:campoTexto id="importeNuevos" editable="false" soloLectura="true" longitudMaxima="13" anchura="100">
						<cmz:formateaNumero valor="${tratamientoPagos.importeAgrupado}"/>
                      </cmz:campoTexto>
                    </td>
                    <td width="60px">Pendiente:</td>
                    <td>
                      <cmz:campoTexto id="pendiente" editable="false" soloLectura="true" longitudMaxima="13" anchura="100">
						<cmz:formateaNumero valor="${tratamientoPagos.importePendiente}" numDecimales="2"/>
                      </cmz:campoTexto>
                    </td>
                  </tr>
                </table>
