...
<jsp:useBean id="paramBuscarRemesasPagos" type="com.comerzzia.persistencia.tesoreria.remesas.pagos.ParametrosBuscarRemesasPagosBean" scope="session" />
    ...
    <script type="text/javascript">
        ...
        function exportarRemesa(idObjeto) {
        	if(confirm("¿Está seguro de que desea exportar la remesa?")) {
        		...
        		document.getElementById("frmDatos").action = "exportacionRemesasPagos";
        		document.getElementById("frmDatos").submit();
        		document.getElementById("frmDatos").action = "remesasPagos";
        	}
        }

        function imprimir(idObjeto){
            document.getElementById("accion").value = "tesoreria.pagos.infremesapagos";
      ...
      <cmz:panelCMZ>
        ...
        <cmz:cuerpoPanelCMZ>
          ...
          <form id="frmDatos" name="frmDatos" action="remesasPagos" method="POST">
            ...
            <cmz:panel>
              <cmz:cabeceraPanel titulo="Búsqueda de Remesas de Pagos"></cmz:cabeceraPanel>
              <cmz:cuerpoPanel>
                <table cellpadding="0px" cellspacing="0px" border="0px">
                  <tr>
                        ...
                        <tr>
                          ...
                          <td>
				            <cmz:ayuda nombreAyuda="BANCOS">
				              <cmz:codigoAyuda idCodigo="codBanco" longitudMaximaCodigo="11" valorCodigo="${paramBuscarRemesasPagos.codBanco}" anchuraCodigo="90px"></cmz:codigoAyuda>
				              <cmz:descripcionAyuda idDescripcion="desBanco" anchuraDescripcion="300px" valorDescripcion="${paramBuscarRemesasPagos.desBanco}"></cmz:descripcionAyuda>
				            </cmz:ayuda>
                          </td>
                        </tr>
			            ...
			            <tr>
                          <td colspan="3">
                              ...
                              <tr>
                                <td>Fecha desde:</td>
                                <td>
                                  <cmz:campoFecha id="fechaDesde" longitudMaxima="10" anchura="100px" requerido="false" editable="true" mostrarCheckbox="true" marcarCheckbox="${paramBuscarRemesasPagos.buscarPorFechaDesde}">
                                    <fmt:formatDate pattern="dd/MM/yyyy" value="${paramBuscarRemesasPagos.fechaDesde}"/>
                                  </cmz:campoFecha>
                                </td>
                                <td width="20px"></td>
                                <td>Fecha hasta:</td>
                                <td>
                                  <cmz:campoFecha id="fechaHasta" longitudMaxima="10" anchura="100px" requerido="false" editable="true" mostrarCheckbox="true" marcarCheckbox="${paramBuscarRemesasPagos.buscarPorFechaHasta}">
                                    <fmt:formatDate pattern="dd/MM/yyyy" value="${paramBuscarRemesasPagos.fechaHasta}"/>
                                  </cmz:campoFecha>
                                </td>
                              </tr>
                          	</table>
                    ...
                    <td valign="top">
                      <cmz:cuadroEstados titulo="Estados" estados="${paramBuscarRemesasPagos.estados.listaEstados}">
                      </cmz:cuadroEstados>
                    </td>
            ...
            <c:choose>
              <c:when test="${paginaResultados.pagina != null}">
                <cmz:panel>
                  ...
                  <cmz:cuerpoPanel>
                    <cmz:listaPaginada>
                      <cmz:cabeceraListaPaginada ordenActual="${paramBuscarRemesasPagos.orden}">
                        ...
                        <cmz:itemCabeceraListaPaginada nombre="Descripción"></cmz:itemCabeceraListaPaginada>
                        <cmz:itemCabeceraListaPaginada nombre="Tipo Efecto" columna="4" ordenColumna="CODTIPOEFEC"></cmz:itemCabeceraListaPaginada>
                        <cmz:itemCabeceraListaPaginada nombre="Descripción"></cmz:itemCabeceraListaPaginada>
						<cmz:itemCabeceraListaPaginada nombre="Estado" estilo="text-align: center;"></cmz:itemCabeceraListaPaginada>
                        <cmz:itemCabeceraListaPaginada nombre="Efectos" estilo="text-align: right;"></cmz:itemCabeceraListaPaginada>
                        <cmz:itemCabeceraListaPaginada nombre="Importe" estilo="text-align: right;"></cmz:itemCabeceraListaPaginada>
                      ...
                      <cmz:contenidoListaPaginada variable="remesa" paginaResultados="${paginaResultados}">
                        ...
                        <cmz:itemContenidoListaPaginada valor="${remesa.codTipoEfecto}" alineacion="left"></cmz:itemContenidoListaPaginada>
                        <cmz:itemContenidoListaPaginada valor="${remesa.desTipoEfecto}" alineacion="left"></cmz:itemContenidoListaPaginada>
                        <cmz:itemContenidoListaPaginada alineacion="center">
                          <img border="0" align="absmiddle" alt="<c:out value="${remesa.desEstado}" />" title="<c:out value="${remesa.desEstado}" />" src="<c:out value="${paramBuscarRemesasPagos.estados.estados[remesa.estado].icono}" />"/>
                        </cmz:itemContenidoListaPaginada>
                        ...
                        <cmz:acciones alineacion="center">
                          ...
                          <c:if test="${permisos.puedeEjecutar && remesa.estado == remesa.ESTADO_PREREMESA}">
                            <cmz:accion icono="tesoreria/remesas/pagos/buscar/images/convertirRemesa.gif" onclick="convertirRemesa('${remesa.idRemesa}');" descripcion="Convertir en Remesa"></cmz:accion>
                          </c:if>
                        </cmz:acciones>  
