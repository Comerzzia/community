...
<html>
  <head>
    ...
    <script type="text/javascript">
	    function inicio() {
	        document.getElementById("codTipoEfectoDesde").focus();
	    }
	    function volver() {
  ...
  <body onload="inicio();" >
    <cmz:main>
      <cmz:panelCMZ>
        ...
        <cmz:cuerpoPanelCMZ>
          <cmz:mensaje/>
          <form id="frmDatos" name="frmDatos" action="tiposEfectos" method="POST" target="_self">
	              ...
	              <tr>
	                ...
	                <td>
	                	<cmz:ayuda nombreAyuda="TIPOSEFECTOS">
	                		<cmz:codigoAyuda idCodigo="codTipoEfectoDesde" longitudMaximaCodigo="2" anchuraCodigo="70px"  />
	                		<cmz:descripcionAyuda idDescripcion="desTipoEfectoDesde" anchuraDescripcion="200px"  />
	                	</cmz:ayuda>
	                </td>
				  </tr>	                
	              <tr>
	                ...
	                <td>
	                	<cmz:ayuda nombreAyuda="TIPOSEFECTOS">
	                		<cmz:codigoAyuda idCodigo="codTipoEfectoHasta" longitudMaximaCodigo="2" anchuraCodigo="70px" />
	                		<cmz:descripcionAyuda idDescripcion="desTipoEfectoHasta" anchuraDescripcion="200px" />
	                	</cmz:ayuda>
	                </td>
				  </tr>
	              <tr>
