...
public class DetalleFacturaCompraBean extends MantenimientoBean implements ILineaDocumento {

	/**
	 * 
	 */
	private static final long serialVersionUID = 3994509533551877727L;

	private Long idFacturaSop = null; // PK
	...
	/**
	 * Obtiene el importe total como la suma del precio mas los impuestos
	 * @return
	 */
	public Double getTotal() {
		return Numero.redondea(precio + impuestos, 2);
	}
}
