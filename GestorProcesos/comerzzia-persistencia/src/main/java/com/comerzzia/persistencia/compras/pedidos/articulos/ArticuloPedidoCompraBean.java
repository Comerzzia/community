...
public class ArticuloPedidoCompraBean extends MantenimientoBean implements ILineaDocumento, IArticuloStock {
	...
	private Double cantidadMedidaRecepcionada = null;
	private Double cantidadRecepcionada = null;
	...
	public Double getCantidadMedidaRecepcionada() {
		return cantidadMedidaRecepcionada;
	}
	public void setCantidadMedidaRecepcionada(Double cantidadMedidaRecepcionada) {
		this.cantidadMedidaRecepcionada = cantidadMedidaRecepcionada;
	}
	
	
	public Double getCantidadRecepcionada() {
		return cantidadRecepcionada;
	}
	public void setCantidadRecepcionada(Double cantidadRecepcionada) {
		this.cantidadRecepcionada = cantidadRecepcionada;
	}
	
	/**
	 * Devuelve la cantidad medida (solicitada, aceptada o recepcionada), que puede ser distinta en función del estado,
	...
	public Double getCantidadMedida() {
		if(cantidadMedidaRecepcionada != null) {
			return cantidadMedidaRecepcionada;
		}
	...
	/**
	 * Devuelve la cantidad (solicitada, aceptada o recepcionada), que puede ser distinta en función del estado,
	...
	public Double getCantidad() {
		...
		// TODO: Usar constantes de EstadosPedidosCompra
		switch (getLineaEstado()) {
			case EstadosPedidosCompra.ESTADO_LINEA_SOLICITADA:
			case EstadosPedidosCompra.ESTADO_LINEA_PDTE_ACEPT:
				return cantidadSolicitada;
				
			case EstadosPedidosCompra.ESTADO_EMISOR_PDTE_RECEP:
				return cantidadAceptada;
				
			case EstadosPedidosCompra.ESTADO_LINEA_RECEPCIONADA:
				return cantidadRecepcionada;
