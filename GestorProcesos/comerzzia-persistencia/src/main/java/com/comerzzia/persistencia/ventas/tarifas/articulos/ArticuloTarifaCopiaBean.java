...
public class ArticuloTarifaCopiaBean extends ArticuloTarifaBean {

	/**
	 * Serial Version UID
	 */
	private static final long serialVersionUID = -1404430018081224677L;
	...
	public void setCodTarOrigen(String codTarOrigen) {
		this.codTarOrigen = codTarOrigen.toUpperCase();
	}
	...
	public void setCodArtOrigen(String codArtOrigen) {
		this.codArtOrigen = codArtOrigen.toUpperCase();
	}
