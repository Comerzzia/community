...
package com.comerzzia.persistencia.ventas.pedidos.impuestos;
...
public class ImpuestosPedidosVentasDao extends MantenimientoDao {
	
	private static String TABLA = "D_CLIE_PEDIDOS_IMP_TBL";
	
	private static Logger log = Logger.getMLogger(ImpuestosPedidosVentasDao.class);
	...
	public static List<ImpuestoBean> consultar(Connection conn, ConfigEmpresaBean config, Long idPedido) throws SQLException {
    	...
    	sql = "SELECT ID_CLIE_PEDIDO, CODIMP, BASE, IMPUESTOS, TOTAL " +
    	...
    	try {
        	...
        	while (rs.next()){
        		...
        		impuesto.setIdDocumento(rs.getLong("ID_CLIE_PEDIDO"));
	...
	public static void insert(Connection conn, ConfigEmpresaBean config, ImpuestoBean impuesto) throws SQLException {
		...
		sql = "INSERT INTO " + getNombreElemento(config.getEsquemaEmpresa(), TABLA) + 
		      "(ID_CLIE_PEDIDO, CODIMP, BASE, IMPUESTOS, TOTAL) VALUES " +
		      "(?, ?, ?, ?, ?)";
