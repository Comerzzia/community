...
package com.comerzzia.persistencia.compras.facturas.impuestos;
...
public class ImpuestosFacturasComprasDao extends MantenimientoDao {

	protected static final String TABLA = "D_FACTURAS_SOP_IMP_TBL";
	
	/** Logger */
	protected static Logger log = Logger.getMLogger(ImpuestosFacturasComprasDao.class);
	...
	public static void insert(Connection conn, ConfigEmpresaBean config, ImpuestoBean impuesto) throws SQLException {
		...
		sql = "INSERT INTO " + getNombreElemento(config.getEsquemaEmpresa(), TABLA) + 
		      "(ID_FACTURA_SOP, CODIMP, BASE, IMPUESTOS, TOTAL) VALUES " +
		      "(?, ?, ?, ?, ?)";
