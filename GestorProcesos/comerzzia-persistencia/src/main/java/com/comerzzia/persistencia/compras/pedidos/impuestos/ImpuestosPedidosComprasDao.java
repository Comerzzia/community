...
package com.comerzzia.persistencia.compras.pedidos.impuestos;
...
public class ImpuestosPedidosComprasDao extends MantenimientoDao {
	
	private static String TABLA = "D_PROV_PEDIDOS_IMP_TBL";
	
	private static Logger log = Logger.getMLogger(ImpuestosPedidosComprasDao.class);
	

	public static List<ImpuestoBean> consultar(Connection conn, ConfigEmpresaBean config, Long idPedido) throws SQLException {
    	...
    	sql = "SELECT ID_PROV_PEDIDO, CODIMP, BASE, IMPUESTOS, TOTAL " +
    	...
    	try {
        	...
        	while (rs.next()){
        		...
        		impuesto.setIdDocumento(rs.getLong("ID_PROV_PEDIDO"));
	...
	public static void insert(Connection conn, ConfigEmpresaBean config, ImpuestoBean impuesto) throws SQLException {
		...
		sql = "INSERT INTO " + getNombreElemento(config.getEsquemaEmpresa(), TABLA) + 
		      "(ID_PROV_PEDIDO, CODIMP, BASE, IMPUESTOS, TOTAL) VALUES " +
		      "(?, ?, ?, ?, ?)";
