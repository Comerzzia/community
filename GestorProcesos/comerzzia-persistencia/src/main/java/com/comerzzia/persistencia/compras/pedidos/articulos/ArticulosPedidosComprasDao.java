...
package com.comerzzia.persistencia.compras.pedidos.articulos;
...
public class ArticulosPedidosComprasDao extends MantenimientoDao {

	private static String TABLA = "D_PROV_PEDIDOS_DET_TBL";
	private static String VISTA = "D_PROV_PEDIDOS_DET";
	
	private static Logger log = Logger.getMLogger(ArticulosPedidosComprasDao.class);
	
	public static List<ArticuloPedidoCompraBean> consultar(Connection conn, ConfigEmpresaBean config, Long idPedido) 
			throws SQLException {
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		String sql = null;
		
		List<ArticuloPedidoCompraBean> detalles = null;
		...
		try {
			...
			detalles = new ArrayList<ArticuloPedidoCompraBean>();
			while (rs.next()) {
				ArticuloPedidoCompraBean articulo = new ArticuloPedidoCompraBean();
				articulo.setIdPedido(rs.getLong("ID_PROV_PEDIDO"));
				...
				articulo.setCantidadMedidaRecepcionada((rs.getString("CANTIDAD_MEDIDA_RECEPCIONADA") != null) ? rs.getDouble("CANTIDAD_MEDIDA_RECEPCIONADA") : null);
				articulo.setCantidadRecepcionada((rs.getString("CANTIDAD_RECEPCIONADA") != null) ? rs.getDouble("CANTIDAD_RECEPCIONADA") : null);
	...
	public static void insert(Connection conn, ConfigEmpresaBean config, ArticuloPedidoCompraBean articulo) throws SQLException {
		PreparedStatement pstmt = null;
		String sql = null;
		...
		try {
			...
			pstmt.setDouble(13, articulo.getCantidadMedidaRecepcionada());
			pstmt.setDouble(14, articulo.getCantidadRecepcionada());
	...
	public static void update(Connection conn, ConfigEmpresaBean config, ArticuloPedidoCompraBean detalle) throws SQLException {
		PreparedStatement pstmt = null;
		String sql = null;
		...
		try {
			...
			pstmt.setDouble(11, detalle.getCantidadMedidaRecepcionada());
			pstmt.setDouble(12, detalle.getCantidadRecepcionada());
	...
	public static void delete(Connection conn, ConfigEmpresaBean config, ArticuloPedidoCompraBean detalle) throws SQLException {
	...
	public static void cambiarEstado(Connection conn, ConfigEmpresaBean config, ArticuloPedidoCompraBean articulo) throws SQLException {
		PreparedStatement pstmt = null;
		String sql = null;
