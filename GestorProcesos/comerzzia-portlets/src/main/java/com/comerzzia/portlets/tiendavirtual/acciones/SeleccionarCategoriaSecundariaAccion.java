...
public class SeleccionarCategoriaSecundariaAccion extends Accion {

	public String getNombre() {
		return "seleccionarCategoriaSecundaria";
	}
	...
	public Vista ejecutar(ActionRequest request) {
		try {
			...
			formulario.seleccionarCategoriaSecundaria(request.getParameter("codCatSecundaria"));
