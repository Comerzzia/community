 ...
 */
public abstract class AccionInicio {
     ...
     * @return 
     */
	public abstract Vista ejecutar(RenderRequest request);


	public void setMensajeError(RenderRequest request, String msg){
		request.setAttribute(WebKeys.MENSAJE_ERROR, msg);
	}

	public void setMensajeInfo(RenderRequest request, String msg){
