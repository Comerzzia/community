...
public class EliminarArticuloCestaAccion extends Accion {

	public String getNombre() {
		return "eliminarArticuloCesta";
	}
	...
	public Vista ejecutar(ActionRequest request) {
		try{
			...
			cesta.eliminarArticulo(codArticulo);
			...
			e.printStackTrace();
			setMensajeError(request, "Se ha producido un error inesperado al intentar eliminar el artículo seleccionado de la cesta.");
